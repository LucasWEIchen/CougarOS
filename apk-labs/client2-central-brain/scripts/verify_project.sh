...
if [[ -d "$WORK_DIR" ]]; then
  ...
  rg -q "centralBrainPhoneTrigger" "$WORK_DIR/res/layout/main_layout.xml"
  rg -q "centralBrainNavigationTrigger" "$WORK_DIR/res/layout/main_layout.xml"
  rg -q "centralBrainFreeformInputOverlay" "$WORK_DIR/res/layout/main_layout.xml"
  rg -q "centralBrainFreeformInput" "$WORK_DIR/res/layout/main_layout.xml"
  rg -q "centralBrainFreeformSubmitButton" "$WORK_DIR/res/layout/main_layout.xml"
  ...
  rg -q 'centralBrainPhoneTrigger.*android:tag="central_brain_freeform_toggle".*android:layout_weight="1.0".*android:background="@android:color/transparent".*android:clickable="true".*android:contentDescription="AIOS text input"' "$WORK_DIR/res/layout/main_layout.xml"
  rg -q 'Space.*android:layout_weight="0.625"' "$WORK_DIR/res/layout/main_layout.xml"
  ...
  rg -q 'Space.*android:layout_weight="11.875"' "$WORK_DIR/res/layout/main_layout.xml"
  rg -q 'centralBrainFreeformInput.*android:maxLength="1024"' "$WORK_DIR/res/layout/main_layout.xml"
