...
def patch_layout(work_dir: Path, patch_xml: Path) -> None:
    ...
    required_markers = [
        ...
        "@+id/centralBrainTimelineIntentText",
        "@+id/centralBrainTimelineContextText",
        "@+id/centralBrainTimelinePlanText",
        "@+id/centralBrainTimelinePolicyText",
        "@+id/centralBrainTimelineGraphText",
        "@+id/centralBrainTimelineEffectText",
        "@+id/centralBrainTimelineReadbackText",
        "@+id/centralBrainExecutionActionsText",
        "@+id/centralBrainExecutionChainText",
