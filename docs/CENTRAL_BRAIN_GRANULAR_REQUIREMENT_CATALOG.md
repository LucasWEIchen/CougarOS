...
- **当前状态**：`TESTBOARD_PARTIAL_VERIFIED / ORBIT_BLOCKED_NO_TOUCH_DEVICE`。1.5 render scale/2880x1620、双区初始值与 18.0/30.0°C 边界、0.5°C 步进、车门、座椅、真实模型闭环和稳定性已通过；旋转等待真实触摸设备。
