...
`P2-W02 Vehicle capability catalog` 已完成。SDK 通过
...
source/quality/freshness，`vehicle/capability` 提供 8 项 range/risk/dependency/activation metadata；两者都
没有 provider/property mapping。下一开发工作包是 `P2-W03 VehicleDigitalTwinStore`。
