...
`vehicle_signal_provider_wired=false`、`vehicle_property_mapping_configured=false`、`hardware_accessed=false`、
`production_ready=false`、`target_hardware_validated=false`、`implementation_stage=P7-W01`。tracking：`DEV-076`、`ISSUE-031`。
...
`target_hardware_validated=false`、`implementation_stage=P7-W01`。tracking：`DEV-075`、`ISSUE-031`。
