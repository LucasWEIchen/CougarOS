...
| A6.1 | 驱动接口支持矩阵 | Android/Linux 驱动能力、缺口、最小新增开发量 | 初版完成 + `/native/driver-gaps` + `/hardware/interfaces` + `/hardware/interfaces/activation-checklist` + `/hardware/interfaces/owner-decision-status` |
