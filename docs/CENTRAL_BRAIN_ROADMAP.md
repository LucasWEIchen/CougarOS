...
`target_hardware_validated=false`、`implementation_stage=P7-W07`。下一工作包：`P6-W05 Context source adapters`。
...
`production_ready=false`、`target_hardware_validated=false`、`implementation_stage=P7-W07`。下一工作包：
...
`target_hardware_validated=false`、`implementation_stage=P7-W07`。下一工作包：`P7-W01 ModelRequest/Result v2`。
...
`implementation_stage=P7-W07`。下一工作包：`P7-W02 ModelProviderRegistry/health`。
...
`hardware_accessed=false`、`production_ready=false`、`target_hardware_validated=false`、
`implementation_stage=P7-W07`。下一工作包：`P7-W03 PolicyAwareModelRouter`。
...
`npu_accessed=false`、`hardware_accessed=false`、`production_ready=false`、`target_hardware_validated=false`、
`implementation_stage=P7-W07`。下一工作包：`P7-W04 LocalModelProvider`。
...
`npu_accessed=false`、`hardware_accessed=false`、`production_ready=false`、`target_hardware_validated=false`、
`implementation_stage=P7-W07`。下一工作包：`P7-W05 Prompt/Output schema`。
...
`hardware_accessed=false`、`production_ready=false`、`target_hardware_validated=false`、
`implementation_stage=P7-W07`。下一工作包：`P7-W06 Scenario evaluation harness`。
...
`target_hardware_validated=false`、`implementation_stage=P7-W07`。下一工作包：`P7-W07 Resource/thermal admission`。
