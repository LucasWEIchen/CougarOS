...
`target_hardware_validated=false`、`implementation_stage=P6-W06`。下一工作包：`P6-W05 Context source adapters`。
...
`production_ready=false`、`target_hardware_validated=false`、`implementation_stage=P6-W06`。下一工作包：
