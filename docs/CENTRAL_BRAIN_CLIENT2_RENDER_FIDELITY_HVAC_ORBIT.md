...
版本：1.2
日期：2026-07-27
状态：`DESIGN_PUBLISHED_ON_MAIN / IMPLEMENTATION_DRAFT_PR_130 /
ORBIT_PHYSICAL_TOUCH_RETEST_OPEN`

> 发布边界：本文设计已进入 `main`；Java、Unity、APK、恢复脚本和硬件测试修改仍位于
> Draft PR #130（`codex/p4-r7-testboard-render-hvac-orbit`）。本文后续记录的设备结果属于
> Draft 实现证据，不表示对应代码已经合入 `main`。
