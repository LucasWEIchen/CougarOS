...
`hardware_accessed=false`、`implementation_stage=P5-W09`。
...
`implementation_stage=P5-W09`。该历史包的下一工作包为 P4-W10 Scenario/manual-control synchronization。
...
`cockpit_recovery_commands_enabled=false`、`hardware_accessed=false`、`implementation_stage=P5-W09`。
...
`production_effect_dispatch_enabled=false`、`hardware_accessed=false`、`implementation_stage=P5-W09`。
