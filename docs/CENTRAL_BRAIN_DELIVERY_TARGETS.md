...
`hardware_accessed=false`、`implementation_stage=P9-W01`。
...
`implementation_stage=P9-W01`。该历史包的下一工作包为 P4-W10 Scenario/manual-control synchronization。
...
`cockpit_recovery_commands_enabled=false`、`hardware_accessed=false`、`implementation_stage=P9-W01`。
...
`production_effect_dispatch_enabled=false`、`hardware_accessed=false`、`implementation_stage=P9-W01`。
...
`production_ready=false`、`target_hardware_validated=false`、`implementation_stage=P9-W01`。Req IDs：`S2-MEM-001`、
...
`npu_accessed=false`、`hardware_accessed=false`、`production_ready=false`、`target_hardware_validated=false`、
`implementation_stage=P9-W01`。Req IDs：`S2-MEM-001`、`S2-MDL-001`、`S2-SAF-001`、`S2-OBS-001`、
...
`npu_accessed=false`、`hardware_accessed=false`、`production_ready=false`、`target_hardware_validated=false`、
`implementation_stage=P9-W01`。Req IDs：`S2-MEM-001`、`S2-UX-003`、`S2-SAF-001`、`S2-OBS-001`、
...
`target_hardware_validated=false`、`implementation_stage=P9-W01`。Req IDs：`S2-EVT-001`、`NV-G-004`、
...
`target_hardware_validated=false`、`implementation_stage=P9-W01`。Req IDs：`S2-CTX-001`、`S2-EVT-001`、
...
`production_ready=false`、`target_hardware_validated=false`、`implementation_stage=P9-W01`。Req IDs：`S2-UX-002`、
...
`hardware_accessed=false`、`production_ready=false`、`target_hardware_validated=false`、
`implementation_stage=P9-W01`。Req IDs：`S2-MDL-001`、`S2-SAF-001`、`S2-OBS-001`、`NV-G-004`、
...
当前 ADB transport 为 offline，因此没有采集新的目标 evidence。P8-W01 保持 `EXTERNAL_BLOCKED`，P8-W02..W06 不启动；P9-W01 可独立
推进。状态：`target_capability_discovery_contract_defined=true`、`target_capability_read_only_collector_verified=true`、
