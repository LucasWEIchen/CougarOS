...
偏差：contract-test availability 为 1，不代表旧 deterministic Provider 已进入 production composition。Android local、vendor NPU、
cloud 均是 descriptor/placeholder；即使测试发布 HEALTHY，implementation/production eligibility/routing 仍为 false。
