...
| `R7C-E-006` | Intent-first four-stage shell on 1920x1080 Client2 | Intent/Plan/Execution/Result, exact safe frame and HVAC/Seat detail drawer render while control surfaces and dispatch stay disabled |
...
typed SDK cancellation race remains covered by instrumentation. Contract schema 1.3 adds the maintained four-stage shell,
1920x1080 safe-frame and device-detail drawer evidence. Application-layer evidence does not mean scenario/Graph/Effect execution,
HVAC/Seat control surfaces, vehicle readback or production storage is active.
