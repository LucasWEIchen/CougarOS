...
`implementation_stage=P7-W02`。Req IDs：`S2-UX-003`、`S2-HMI-003`、`S2-SAF-001`、`S2-EFF-001`、
...
`cockpit_execution_readback_available=false`, `hardware_accessed=false`, `implementation_stage=P7-W02`.
...
`cockpit_runtime_policy_authority_independent=true`, `hardware_accessed=false`, `implementation_stage=P7-W02`.
...
`XSC-001/005/006`; tracking: `DEV-060`, `ISSUE-022/026/030/033`; `implementation_stage=P7-W02`.
...
`hardware_accessed=false`, `implementation_stage=P7-W02`. Req IDs: `S2-UX-003`, `S2-HMI-001/002`, `APP-004`,
...
`production_ready=false`, `target_hardware_validated=false`, `implementation_stage=P7-W02`. Req IDs:
...
`DEL-001/004/005`; tracking: `DEV-066`, `ISSUE-039`; `implementation_stage=P7-W02`.
...
`production_ready=false`、`target_hardware_validated=false`、`implementation_stage=P7-W02`；tracking：`DEV-069`、`ISSUE-042`。
...
`target_hardware_validated=false`, `implementation_stage=P7-W02`; tracking: `DEV-070`, `ISSUE-043`.
...
`target_hardware_validated=false`, `implementation_stage=P7-W02`; tracking: `DEV-071`, `ISSUE-044`.
...
`target_hardware_validated=false`、`implementation_stage=P7-W02`; tracking: `DEV-072`, `ISSUE-045`.
...
`production_ready=false`、`target_hardware_validated=false`、`implementation_stage=P7-W02`; tracking: `DEV-073`,
`ISSUE-046`。
...
`target_hardware_validated=false`、`implementation_stage=P7-W02`; tracking: `DEV-073`, `ISSUE-046`。
...
`production_ready=false`、`target_hardware_validated=false`、`implementation_stage=P7-W02`; tracking: `DEV-074`, `ISSUE-031`。
...
`target_hardware_validated=false`、`implementation_stage=P7-W02`。Req IDs：`S2-UX-002`、`S2-TRG-002`、
