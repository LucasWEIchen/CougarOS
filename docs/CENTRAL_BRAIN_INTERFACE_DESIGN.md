...
`implementation_stage=P7-W06`。Req IDs：`S2-UX-003`、`S2-HMI-003`、`S2-SAF-001`、`S2-EFF-001`、
...
`cockpit_execution_readback_available=false`, `hardware_accessed=false`, `implementation_stage=P7-W06`.
...
`cockpit_runtime_policy_authority_independent=true`, `hardware_accessed=false`, `implementation_stage=P7-W06`.
...
`XSC-001/005/006`; tracking: `DEV-060`, `ISSUE-022/026/030/033`; `implementation_stage=P7-W06`.
...
`vehicle_signal_provider_wired=false`, `hardware_accessed=false`, `implementation_stage=P7-W06`.
...
`hardware_accessed=false`, `implementation_stage=P7-W06`. Req IDs: `S2-UX-003`, `S2-HMI-001/002`, `APP-004`,
...
`production_ready=false`, `target_hardware_validated=false`, `implementation_stage=P7-W06`. Req IDs:
...
`target_hardware_validated=false`, `implementation_stage=P7-W06`. Req IDs: `S2-TOL-001`, `S2-SAF-001`, `S2-OBS-001`,
...
`production_ready=false`, `target_hardware_validated=false`, `implementation_stage=P7-W06`. Req IDs: `S2-TOL-001`,
...
`implementation_stage=P7-W06`. Req IDs: `S2-TOL-001`, `S2-SAF-001`, `S2-OBS-001`, `DEL-001/004/005`;
...
`DEL-001/004/005`; tracking: `DEV-066`, `ISSUE-039`; `implementation_stage=P7-W06`.
...
`target_hardware_validated=false`, `implementation_stage=P7-W06`. Req IDs: `S2-MEM-001`, `S2-SAF-001`,
...
`production_ready=false`、`target_hardware_validated=false`、`implementation_stage=P7-W06`；tracking：`DEV-069`、`ISSUE-042`。
...
`target_hardware_validated=false`, `implementation_stage=P7-W06`; tracking: `DEV-070`, `ISSUE-043`.
...
`target_hardware_validated=false`, `implementation_stage=P7-W06`; tracking: `DEV-071`, `ISSUE-044`.
...
`target_hardware_validated=false`、`implementation_stage=P7-W06`; tracking: `DEV-072`, `ISSUE-045`.
...
`production_ready=false`、`target_hardware_validated=false`、`implementation_stage=P7-W06`; tracking: `DEV-073`,
`ISSUE-046`。
...
`target_hardware_validated=false`、`implementation_stage=P7-W06`; tracking: `DEV-073`, `ISSUE-046`。
...
`production_ready=false`、`target_hardware_validated=false`、`implementation_stage=P7-W06`; tracking: `DEV-074`, `ISSUE-031`。
...
`target_hardware_validated=false`、`implementation_stage=P7-W06`。Req IDs：`S2-SAF-001`、`S2-MEM-001`、
...
`production_ready=false`、`target_hardware_validated=false`、`implementation_stage=P7-W06`。Req IDs：`S2-CTX-001`、
...
`target_hardware_validated=false`、`implementation_stage=P7-W06`。Req IDs：`S2-UX-002`、`S2-TRG-002`、
...
`implementation_stage=P7-W06`。Req IDs：`S2-MDL-001`、`S2-SAF-001`、`S2-OBS-001`、`DEL-001/004/005`；
