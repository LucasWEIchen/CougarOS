...
- Linux shared governance daemon sample：`central_brain_governance_daemon.py` 通过 Unix socket 提供 `governance.precheck`、`governance.runtime.get` 和 `audit.recent.get`，可供 Linux IPC `soa.service.invoke` 转发前复用并直接查看治理状态/审计，覆盖 XSC-005、XSC-006、NV-G-001、NV-G-002、NV-G-004、NV-G-005、NV-G-006、NV-G-007、NV-P-002、DEL-002。
