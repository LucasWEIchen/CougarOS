...
- `GET /uib/events/subscriptions`、`POST /uib/events/subscriptions/request`、`POST /uib/events/subscriptions/cancel`：Uni Info Bus Event subscription lifecycle command contract，暴露 lifecycle、cursor/replay、filter、QoS/backpressure、governance、request/cancel、Android/Linux parity 和 no-persistence/no-broker/no-DDS 边界，覆盖 XSC-002、FW-U-003、XSC-005、XSC-006、NV-P-002、NV-P-003、NV-P-006、DEL-001、DEL-002；当前不实现真实订阅 broker、callback/watch、SSE/WebSocket、DDS runtime 或高频数据面。
