...
PROTOTYPE_MODULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "yellow_sun_portable": True,
        "current_state": "empty-interface-registry-with-activation-checklist-owner-decision-status-and-evidence-intake-contract",
        "ready_for": ["interface ownership review", "hardware activation checklist review", "hardware owner decision status review", "hardware owner decision evidence intake contract review", "future HAL/vendor SDK scoping", "no-hardware smoke validation"],
        ...
        "linux_sync_surface": "hardware-interfaces, hardware-interface-activation-checklist, hardware-interface-owner-decision-status, and hardware-interface-owner-decision-evidence over CLI/IPC/gRPC",
    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface owner decision evidence status rollup",
                    "reason": "HW-002/KH owner evidence intake is contract-only; the next safe step is a no-store review/status rollup for submitted reference envelopes without persistence, owner assignment, gate closure, or hardware activation.",
