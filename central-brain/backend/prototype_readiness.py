            ...
            "next_increment_candidates": [
                {
                    ...
                    "reason": "HW-AHK closure handoff readiness summary is now visible; an event-safe step can validate activation approval requests without persisting evidence, closing gates, or activating a broker.",
