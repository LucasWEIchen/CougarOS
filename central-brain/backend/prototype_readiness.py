    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load approval reviewer evidence handoff checklist",
                    "reason": "Approval decision closure blockers and reviewer matrix are visible; a later hardware-safe step can define the evidence handoff checklist for reviewer-owned artifacts without persisting evidence, closing gates, or loading adapters.",
