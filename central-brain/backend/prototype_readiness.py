...
PROTOTYPE_MODULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "yellow_sun_portable": True,
        "current_state": "active-semantic-mock-with-subscription-lifecycle-transport-readiness-decision-matrix-activation-checklist-callback-watch-shape-cursor-replay-storage-backpressure-qos-evidence-readiness-rollup-activation-evidence-intake-status-retention-checklist-decision-status-rollup-approval-dry-run-status-and-approval-authority-checklist-contract",
        "ready_for": ["semantic gateway smoke", "bounded event-log validation", "event subscription request/cancel contract review", "callback/watch transport readiness review", "broker/cursor/backpressure owner decision review", "activation evidence checklist review", "activation evidence intake contract review", "activation evidence review status contract review", "activation evidence retention owner checklist review", "activation evidence decision status rollup review", "activation approval dry-run status review", "activation approval authority checklist review", "callback/watch API shape review", "cursor/replay storage contract review", "backpressure/QoS evidence contract review", "end-to-end readiness rollup review", "extension contract review"],
        ...
        "linux_sync_surface": "state, events, event-subscriptions, event-subscribe-request, event-subscribe-cancel, event-subscription-transport-readiness, event-subscription-decision-matrix, event-subscription-activation-checklist, event-subscription-callback-watch-shape, event-subscription-cursor-replay-storage, event-subscription-backpressure-qos-evidence, event-subscription-readiness-rollup, event-subscription-activation-evidence, event-subscription-activation-evidence-status, event-subscription-activation-evidence-retention-checklist, event-subscription-activation-evidence-decision-status-rollup, event-subscription-activation-approval-dry-run-status, event-subscription-activation-approval-authority-checklist, extensions, action-request over CLI/IPC/gRPC",
