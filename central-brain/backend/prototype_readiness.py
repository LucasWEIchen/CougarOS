    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load approval reviewer handoff acceptance audit consistency",
                    "reason": "Reviewer handoff acceptance status is now visible; a later hardware-safe step can cross-check handoff checklist and acceptance status without accepting packets, persisting evidence, closing gates, or loading adapters.",
