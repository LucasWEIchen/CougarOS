    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load approval reviewer handoff acceptance closure readiness decision rollup",
                    "reason": "Reviewer handoff acceptance closure readiness audit consistency is now visible; a later hardware-safe step can summarize closure readiness blockers and audit results without accepting packets, persisting evidence, closing gates, or loading adapters.",
