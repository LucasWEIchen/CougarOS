    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load approval reviewer handoff acceptance closure readiness audit consistency",
                    "reason": "Reviewer handoff acceptance closure readiness checklist is now visible; a later hardware-safe step can audit checklist, decision rollup, and no-side-effect counters without accepting packets, persisting evidence, closing gates, or loading adapters.",
