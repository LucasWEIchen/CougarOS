    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load approval reviewer handoff acceptance closure readiness checklist",
                    "reason": "Reviewer handoff acceptance decision rollup is now visible; a later hardware-safe step can enumerate closure readiness criteria without accepting packets, persisting evidence, closing gates, or loading adapters.",
