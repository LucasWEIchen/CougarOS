    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "event subscription activation approval decision owner handoff evidence acceptance closure handoff readiness audit consistency",
                    "reason": "Closure handoff readiness summary is now visible; a later event-safe step can audit handoff dependency counts and blockers without assigning reviewers, accepting packets, creating stores or review queues, closing gates, broker activation, Driver/HAL, or virtualization work.",
