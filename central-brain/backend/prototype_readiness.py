    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load approval reviewer handoff acceptance decision rollup",
                    "reason": "Reviewer handoff acceptance audit consistency is now visible; a later hardware-safe step can summarize the blocked handoff acceptance decision without accepting packets, persisting evidence, closing gates, or loading adapters.",
