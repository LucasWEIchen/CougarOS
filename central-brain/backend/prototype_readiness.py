    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load closure decision reviewer assignment audit consistency",
                    "reason": "Closure decision reviewer assignment checklist is now visible; a later hardware-safe step can audit that reviewer assignment state stays no-store, unassigned, and Android/Linux synchronized.",
