...
PROTOTYPE_MODULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "yellow_sun_portable": True,
        "current_state": "empty-interface-registry-with-activation-checklist-owner-decision-status-evidence-intake-status-retention-closure-replacement-trigger-selected-adapter-readiness-adapter-load-blocker-rollup-adapter-load-dry-run-status-audit-consistency-approval-authority-checklist-status-audit-consistency-approval-decision-dry-run-status-audit-consistency-closure-blocker-matrix-reviewer-matrix-evidence-handoff-checklist-handoff-acceptance-status-handoff-acceptance-audit-consistency-handoff-acceptance-decision-rollup-handoff-acceptance-closure-readiness-checklist-closure-readiness-audit-consistency-closure-readiness-decision-rollup-closure-decision-reviewer-assignment-checklist-and-reviewer-assignment-audit-consistency-contract",
        "ready_for": ["interface ownership review", "hardware activation checklist review", "hardware owner decision status review", "hardware owner decision evidence intake contract review", "hardware owner decision evidence status review", "hardware owner decision evidence retention and closure checklist review", "hardware owner evidence replacement trigger checklist review", "hardware owner evidence selected-adapter readiness checklist review", "hardware owner evidence adapter load blocker rollup review", "hardware owner evidence adapter load dry-run review", "hardware owner evidence adapter load dry-run no-store status review", "hardware owner evidence adapter load dry-run audit consistency review", "hardware owner evidence adapter load approval authority checklist review", "hardware owner evidence adapter load approval authority no-store status review", "hardware owner evidence adapter load approval authority audit consistency review", "hardware owner evidence adapter load approval decision dry-run status review", "hardware owner evidence adapter load approval decision dry-run audit consistency review", "hardware owner evidence adapter load approval decision closure blocker matrix review", "hardware owner evidence adapter load approval decision reviewer matrix review", "hardware owner evidence adapter load approval reviewer evidence handoff checklist review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance status review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance audit consistency review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance decision rollup review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance closure readiness checklist review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance closure readiness audit consistency review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance closure readiness decision rollup review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance closure readiness decision reviewer assignment checklist review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance closure readiness decision reviewer assignment audit consistency review", "future HAL/vendor SDK scoping", "no-hardware smoke validation"],
    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load closure decision reviewer assignment audit decision rollup",
                    "reason": "Closure decision reviewer assignment audit consistency is now visible; a later hardware-safe step can summarize whether reviewer assignment audit still blocks adapter load without creating reviewers, queues, stores, gates, or hardware access.",
