    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load approval decision audit consistency view",
                    "reason": "Approval decision dry-run and no-store status are visible; a later hardware-safe step can cross-check decision dry-run/status, approval authority audit, approval status, and blocker rollup without calling POST paths, persisting approvals, closing gates, or loading adapters.",
