    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load approval decision closure blocker matrix",
                    "reason": "Approval decision dry-run, status, and audit consistency are visible; a later hardware-safe step can make unresolved approval authority, policy, signature, RBAC, record schema, evidence store, review workflow, target smoke, rollback, fault, Driver/HAL gap, and gate closure authority dependencies machine-readable.",
