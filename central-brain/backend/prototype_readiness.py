    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load closure decision reviewer assignment checklist",
                    "reason": "Closure readiness decision rollup is now visible; a later hardware-safe step can expose who must review each remaining closure blocker before any real adapter-load approval can proceed.",
