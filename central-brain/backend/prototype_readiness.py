    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load approval reviewer handoff acceptance status",
                    "reason": "Reviewer evidence handoff packet fields are now visible; a later hardware-safe step can add no-store acceptance status for missing handoff packets without assigning reviewers, persisting evidence, closing gates, or loading adapters.",
