    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load approval authority audit consistency view",
                    "reason": "Approval authority checklist and no-store status are visible; a later hardware-safe step can cross-check checklist/status surfaces without persisting approvals, closing gates, or loading adapters.",
