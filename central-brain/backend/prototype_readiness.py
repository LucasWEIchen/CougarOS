    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "event subscription activation approval decision owner handoff evidence acceptance decision rollup",
                    "reason": "Owner handoff evidence acceptance audit consistency is now visible; a later event-safe step can summarize the still-blocked acceptance decision without accepting packets, creating stores or review queues, closing gates, broker activation, Driver/HAL, or virtualization work.",
