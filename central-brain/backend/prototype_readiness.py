    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "event subscription activation approval decision owner handoff evidence acceptance status",
                    "reason": "Owner handoff evidence readiness audit consistency is now visible; a later event-safe step can define blocked/no-store evidence acceptance status before accepting packets, creating stores or review queues, closing gates, broker activation, Driver/HAL, or virtualization work.",
