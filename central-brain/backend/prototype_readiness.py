...
PROTOTYPE_MODULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "yellow_sun_portable": True,
        "current_state": "active-semantic-mock-with-subscription-lifecycle-transport-readiness-decision-matrix-activation-checklist-callback-watch-shape-cursor-replay-storage-backpressure-qos-evidence-readiness-rollup-activation-evidence-intake-status-retention-checklist-and-decision-status-rollup-contract",
        "ready_for": ["semantic gateway smoke", "bounded event-log validation", "event subscription request/cancel contract review", "callback/watch transport readiness review", "broker/cursor/backpressure owner decision review", "activation evidence checklist review", "activation evidence intake contract review", "activation evidence review status contract review", "activation evidence retention owner checklist review", "activation evidence decision status rollup review", "callback/watch API shape review", "cursor/replay storage contract review", "backpressure/QoS evidence contract review", "end-to-end readiness rollup review", "extension contract review"],
    ...
    },
    {
        ...
        "yellow_sun_portable": True,
        "current_state": "empty-interface-registry-with-activation-checklist-owner-decision-status-evidence-intake-status-retention-closure-replacement-trigger-selected-adapter-readiness-adapter-load-blocker-rollup-adapter-load-dry-run-status-audit-consistency-approval-authority-checklist-status-audit-consistency-approval-decision-dry-run-status-audit-consistency-closure-blocker-matrix-reviewer-matrix-evidence-handoff-checklist-handoff-acceptance-status-handoff-acceptance-audit-consistency-handoff-acceptance-decision-rollup-handoff-acceptance-closure-readiness-checklist-closure-readiness-audit-consistency-closure-readiness-decision-rollup-closure-decision-reviewer-assignment-checklist-reviewer-assignment-audit-consistency-and-reviewer-assignment-audit-decision-rollup-contract",
        "ready_for": ["interface ownership review", "hardware activation checklist review", "hardware owner decision status review", "hardware owner decision evidence intake contract review", "hardware owner decision evidence status review", "hardware owner decision evidence retention and closure checklist review", "hardware owner evidence replacement trigger checklist review", "hardware owner evidence selected-adapter readiness checklist review", "hardware owner evidence adapter load blocker rollup review", "hardware owner evidence adapter load dry-run review", "hardware owner evidence adapter load dry-run no-store status review", "hardware owner evidence adapter load dry-run audit consistency review", "hardware owner evidence adapter load approval authority checklist review", "hardware owner evidence adapter load approval authority no-store status review", "hardware owner evidence adapter load approval authority audit consistency review", "hardware owner evidence adapter load approval decision dry-run status review", "hardware owner evidence adapter load approval decision dry-run audit consistency review", "hardware owner evidence adapter load approval decision closure blocker matrix review", "hardware owner evidence adapter load approval decision reviewer matrix review", "hardware owner evidence adapter load approval reviewer evidence handoff checklist review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance status review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance audit consistency review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance decision rollup review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance closure readiness checklist review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance closure readiness audit consistency review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance closure readiness decision rollup review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance closure readiness decision reviewer assignment checklist review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance closure readiness decision reviewer assignment audit consistency review", "hardware owner evidence adapter load approval reviewer evidence handoff acceptance closure readiness decision reviewer assignment audit decision rollup review", "future HAL/vendor SDK scoping", "no-hardware smoke validation"],
    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "hardware interface adapter-load closure decision reviewer assignment audit closure handoff readiness summary",
                    "reason": "Reviewer assignment audit decision rollup is now visible; a later hardware-safe step can summarize remaining closure handoff readiness blockers without creating reviewers, queues, stores, gates, or hardware access.",
                    "req_ids": ["HW-002", "KH-003", "KH-006", "KH-007", "DEL-005"],
                },
                {
                    "candidate": "event subscription activation approval dry-run status view",
                    "reason": "FW-U-003/NV-P-006 now expose activation evidence decision status; a later event-safe step could validate activation approval requests without persisting evidence, closing gates, or activating a broker.",
