...
PROTOTYPE_MODULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "yellow_sun_portable": True,
        "current_state": "empty-interface-registry-with-activation-checklist-owner-decision-status-evidence-intake-status-retention-closure-replacement-trigger-selected-adapter-readiness-adapter-load-blocker-rollup-adapter-load-dry-run-status-audit-consistency-approval-authority-checklist-status-and-audit-consistency-contract",
        "ready_for": ["interface ownership review", "hardware activation checklist review", "hardware owner decision status review", "hardware owner decision evidence intake contract review", "hardware owner decision evidence status review", "hardware owner decision evidence retention and closure checklist review", "hardware owner evidence replacement trigger checklist review", "hardware owner evidence selected-adapter readiness checklist review", "hardware owner evidence adapter load blocker rollup review", "hardware owner evidence adapter load dry-run review", "hardware owner evidence adapter load dry-run no-store status review", "hardware owner evidence adapter load dry-run audit consistency review", "hardware owner evidence adapter load approval authority checklist review", "hardware owner evidence adapter load approval authority no-store status review", "hardware owner evidence adapter load approval authority audit consistency review", "future HAL/vendor SDK scoping", "no-hardware smoke validation"],
