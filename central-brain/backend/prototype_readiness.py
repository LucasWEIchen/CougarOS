    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "event subscription activation approval decision owner handoff evidence acceptance closure readiness checklist",
                    "reason": "Owner handoff evidence acceptance decision rollup is now visible; a later event-safe step can enumerate closure-readiness prerequisites without accepting packets, creating stores or review queues, closing gates, broker activation, Driver/HAL, or virtualization work.",
