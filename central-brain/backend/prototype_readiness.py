    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "event subscription activation approval decision owner handoff evidence acceptance audit consistency",
                    "reason": "Owner handoff evidence acceptance status is now visible; a later event-safe step can audit acceptance status parity before accepting packets, creating stores or review queues, closing gates, broker activation, Driver/HAL, or virtualization work.",
