...
PROTOTYPE_MODULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "yellow_sun_portable": True,
        "current_state": "active-semantic-mock-with-subscription-lifecycle-transport-readiness-decision-matrix-activation-checklist-callback-watch-shape-cursor-replay-storage-backpressure-qos-evidence-readiness-rollup-activation-evidence-intake-status-retention-checklist-decision-status-rollup-approval-dry-run-status-approval-authority-checklist-and-approval-authority-audit-consistency-contract",
        "ready_for": ["semantic gateway smoke", "bounded event-log validation", "event subscription request/cancel contract review", "callback/watch transport readiness review", "broker/cursor/backpressure owner decision review", "activation evidence checklist review", "activation evidence intake contract review", "activation evidence review status contract review", "activation evidence retention owner checklist review", "activation evidence decision status rollup review", "activation approval dry-run status review", "activation approval authority checklist review", "activation approval authority audit consistency review", "callback/watch API shape review", "cursor/replay storage contract review", "backpressure/QoS evidence contract review", "end-to-end readiness rollup review", "extension contract review"],
    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "event subscription activation approval dry-run request contract",
                    "reason": "Approval dry-run status is visible as no-store/no-side-effect; a later event-safe step can validate an approval request envelope while still rejecting activation and avoiding broker, persistence, gate, Driver/HAL, or virtualization effects.",
