...
PROTOTYPE_MODULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "yellow_sun_portable": True,
        "current_state": "active-semantic-mock-with-subscription-lifecycle-transport-readiness-decision-matrix-activation-checklist-callback-watch-shape-and-cursor-replay-storage-contract",
        "ready_for": ["semantic gateway smoke", "bounded event-log validation", "event subscription request/cancel contract review", "callback/watch transport readiness review", "broker/cursor/backpressure owner decision review", "activation evidence checklist review", "callback/watch API shape review", "cursor/replay storage contract review", "extension contract review"],
        ...
        "linux_sync_surface": "state, events, event-subscriptions, event-subscribe-request, event-subscribe-cancel, event-subscription-transport-readiness, event-subscription-decision-matrix, event-subscription-activation-checklist, event-subscription-callback-watch-shape, event-subscription-cursor-replay-storage, extensions, action-request over CLI/IPC/gRPC",
    ...
    def readiness_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "next_increment_candidates": [
                {
                    "candidate": "event subscription backpressure/QoS evidence contract",
                    "reason": "FW-U-003/NV-P-006 now expose lifecycle commands, callback/watch transport readiness, owner decision matrix, activation evidence checklist, callback/watch API shape, and cursor/replay storage contract; the next safe step is a backpressure/QoS evidence contract that still avoids runtime activation.",
