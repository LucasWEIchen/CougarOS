...
DELIVERY_READINESS_ROWS: list[dict[str, Any]] = [
    ...
    {
        "target": "event-subscription-lifecycle-transport-readiness-decision-matrix-and-activation-checklist-contract",
        "platform": "Android/Linux",
        "current_state": "contract-only-not-brokered-with-activation-evidence-gates",
        "ready_for": [
