...
DELIVERY_READINESS_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "platform": "Android/Linux",
        "current_state": "read-only-empty-interface-activation-checklist-owner-decision-status-evidence-intake-status-retention-closure-and-replacement-trigger-checklist-contract",
        "ready_for": [
        ...
        "blocked_by": [
            "target interface owner, ABI, safety policy, smoke evidence, retention, review, delete/export, gate closure, and replacement trigger decisions",
            "real PCIe NPU hardware and vendor SDK",
