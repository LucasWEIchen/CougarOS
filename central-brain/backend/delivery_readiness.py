...
DELIVERY_READINESS_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "platform": "Android/Linux",
        "current_state": "read-only-empty-interface-activation-checklist-owner-decision-status-evidence-intake-status-retention-closure-replacement-trigger-selected-adapter-readiness-adapter-load-blocker-rollup-adapter-load-dry-run-status-audit-consistency-and-approval-authority-contract",
        "ready_for": [
        ...
        "blocked_by": [
            "target interface owner, ABI, safety policy, smoke evidence, retention, review, delete/export, gate closure, replacement trigger, selected-adapter readiness, adapter-load blocker, adapter-load dry-run approval, dry-run status persistence, dry-run audit consistency, and adapter-load approval authority decisions",
            "real PCIe NPU hardware and vendor SDK",
