...
DELIVERY_READINESS_ROWS: list[dict[str, Any]] = [
    ...
    {
        "target": "event-subscription-lifecycle-transport-readiness-and-decision-matrix-contract",
        "platform": "Android/Linux",
        "current_state": "contract-only-not-brokered-with-owner-decision-matrix",
        "ready_for": [
