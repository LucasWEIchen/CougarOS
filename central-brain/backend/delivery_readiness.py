...
DELIVERY_READINESS_ROWS: list[dict[str, Any]] = [
    ...
    {
        "target": "event-subscription-lifecycle-transport-readiness-decision-matrix-activation-checklist-callback-watch-shape-cursor-replay-storage-backpressure-qos-evidence-readiness-rollup-and-activation-evidence-intake-contract",
        "platform": "Android/Linux",
        "current_state": "contract-only-not-brokered-with-activation-evidence-intake-blocked",
        "ready_for": [
