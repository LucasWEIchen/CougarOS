...
DELIVERY_READINESS_ROWS: list[dict[str, Any]] = [
    ...
    {
        "target": "event-subscription-lifecycle-transport-readiness-decision-matrix-activation-checklist-and-callback-watch-shape-contract",
        "platform": "Android/Linux",
        "current_state": "contract-only-not-brokered-with-callback-watch-shape-draft",
        "ready_for": [
