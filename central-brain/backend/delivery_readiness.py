...
DELIVERY_READINESS_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "platform": "Android/Linux",
        "current_state": "read-only-empty-interface-activation-checklist-owner-decision-status-evidence-intake-status-retention-closure-replacement-trigger-selected-adapter-readiness-adapter-load-blocker-rollup-and-adapter-load-dry-run-contract",
        "ready_for": [
        ...
        "blocked_by": [
            "target interface owner, ABI, safety policy, smoke evidence, retention, review, delete/export, gate closure, replacement trigger, selected-adapter readiness, adapter-load blocker, and adapter-load dry-run approval decisions",
            "real PCIe NPU hardware and vendor SDK",
