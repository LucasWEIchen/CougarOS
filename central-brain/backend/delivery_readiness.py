...
DELIVERY_READINESS_ROWS: list[dict[str, Any]] = [
    ...
    {
        "target": "event-subscription-lifecycle-transport-readiness-decision-matrix-activation-checklist-callback-watch-shape-and-cursor-replay-storage-contract",
        "platform": "Android/Linux",
        "current_state": "contract-only-not-brokered-with-cursor-replay-storage-draft",
        "ready_for": [
