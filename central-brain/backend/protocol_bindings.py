    ...
    def detail_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "constraints": [
                ...
                "The hardware empty-interface catalog is exposed at /hardware/interfaces, /hardware/interfaces/activation-checklist, /hardware/interfaces/owner-decision-status, POST /hardware/interfaces/owner-decision-evidence, GET /hardware/interfaces/owner-decision-evidence/status, GET /hardware/interfaces/owner-decision-evidence/retention-checklist, GET /hardware/interfaces/owner-decision-evidence/replacement-trigger-checklist, GET /hardware/interfaces/owner-decision-evidence/selected-adapter-readiness-checklist, GET /hardware/interfaces/owner-decision-evidence/adapter-load-blocker-rollup, POST /hardware/interfaces/owner-decision-evidence/adapter-load-dry-run, GET /hardware/interfaces/owner-decision-evidence/adapter-load-dry-run/status, and GET /hardware/interfaces/owner-decision-evidence/adapter-load-dry-run/audit-consistency for Android and Linux bindings; it records owner, ABI, Driver/HAL gap, safety policy, smoke-test, rollback decision gates, no-store evidence reference intake, no-store evidence review status, retention/closure checklist decisions, empty-interface replacement trigger gates, selected-adapter readiness evidence, adapter-load blockers, adapter-load approval dry-run rejection, no-store dry-run status, and dry-run audit consistency without opening devices, calling HALs, allocating shared memory, reading evidence stores, updating review queues, creating delete/export workflows, selecting/loading/replacing adapters, closing gates, triggering Driver/HAL development, or performing virtualization work.",
            ],
