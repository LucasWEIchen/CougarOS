    ...
    def detail_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "constraints": [
                ...
                "The hardware empty-interface catalog is exposed at /hardware/interfaces, /hardware/interfaces/activation-checklist, /hardware/interfaces/owner-decision-status, POST /hardware/interfaces/owner-decision-evidence, and GET /hardware/interfaces/owner-decision-evidence/status for Android and Linux bindings; it records owner, ABI, Driver/HAL gap, safety policy, smoke-test, rollback decision gates, no-store evidence reference intake, and no-store evidence review status without opening devices, calling HALs, allocating shared memory, reading evidence stores, updating review queues, closing gates, triggering Driver/HAL development, or performing virtualization work.",
            ],
