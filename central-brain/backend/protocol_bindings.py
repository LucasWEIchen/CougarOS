    ...
    def detail_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "constraints": [
                ...
                "The hardware empty-interface catalog is exposed at /hardware/interfaces, /hardware/interfaces/activation-checklist, /hardware/interfaces/owner-decision-status, POST /hardware/interfaces/owner-decision-evidence, GET /hardware/interfaces/owner-decision-evidence/status, GET /hardware/interfaces/owner-decision-evidence/retention-checklist, GET /hardware/interfaces/owner-decision-evidence/replacement-trigger-checklist, GET /hardware/interfaces/owner-decision-evidence/selected-adapter-readiness-checklist, and GET /hardware/interfaces/owner-decision-evidence/adapter-load-blocker-rollup for Android and Linux bindings; it records owner, ABI, Driver/HAL gap, safety policy, smoke-test, rollback decision gates, no-store evidence reference intake, no-store evidence review status, retention/closure checklist decisions, empty-interface replacement trigger gates, selected-adapter readiness evidence, and adapter-load blockers without opening devices, calling HALs, allocating shared memory, reading evidence stores, updating review queues, creating delete/export workflows, selecting/loading/replacing adapters, closing gates, triggering Driver/HAL development, or performing virtualization work.",
            ],
