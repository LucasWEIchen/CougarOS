...
BINDING_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "semantic_paths": [
            "planned DDS delivery for /uib/events/topics, /uib/events/recent, and /uib/events/subscriptions high-rate topics after request/cancel lifecycle commands, activation checklist, and callback/watch shape leave contract-only mode",
        ],
        "artifacts": [],
