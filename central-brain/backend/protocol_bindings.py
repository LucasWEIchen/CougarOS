...
BINDING_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "semantic_paths": [
            "planned DDS delivery for /uib/events/topics, /uib/events/recent, and /uib/events/subscriptions high-rate topics after request/cancel lifecycle commands leave contract-only mode",
        ],
        "artifacts": [],
    ...
    def detail_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "constraints": [
                ...
                "The Event subscription contract is exposed at /uib/events/subscriptions plus request/cancel lifecycle command endpoints, /uib/events/subscriptions/transport-readiness, and /uib/events/subscriptions/decision-matrix to fix lifecycle, cursor, backpressure, callback/watch readiness, owner decisions, governance, and Android/Linux binding parity without transport selection, persistence, callback/watch registration, broker startup, SSE/WebSocket, DDS runtime, or high-rate data plane.",
