    ...
    def detail_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "constraints": [
                ...
                "The Event subscription contract is exposed at /uib/events/subscriptions plus request/cancel lifecycle command endpoints and /uib/events/subscriptions/transport-readiness to fix lifecycle, cursor, backpressure, callback/watch readiness, governance, and Android/Linux binding parity without transport selection, persistence, callback/watch registration, broker startup, SSE/WebSocket, DDS runtime, or high-rate data plane.",
