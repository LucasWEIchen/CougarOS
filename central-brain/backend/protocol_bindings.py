    ...
    def detail_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "constraints": [
                ...
                "The hardware empty-interface catalog is exposed at /hardware/interfaces, /hardware/interfaces/activation-checklist, /hardware/interfaces/owner-decision-status, and POST /hardware/interfaces/owner-decision-evidence for Android and Linux bindings; it records owner, ABI, Driver/HAL gap, safety policy, smoke-test, rollback decision gates, and no-store evidence reference intake without opening devices, calling HALs, allocating shared memory, updating review queues, closing gates, triggering Driver/HAL development, or performing virtualization work.",
            ],
