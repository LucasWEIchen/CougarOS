    ...
    def detail_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "constraints": [
                ...
                "The Event subscription contract is exposed at /uib/events/subscriptions plus request/cancel lifecycle command endpoints, /uib/events/subscriptions/transport-readiness, /uib/events/subscriptions/decision-matrix, /uib/events/subscriptions/activation-checklist, /uib/events/subscriptions/callback-watch-shape, /uib/events/subscriptions/cursor-replay-storage, and /uib/events/subscriptions/backpressure-qos-evidence to fix lifecycle, cursor, replay storage, backpressure/QoS evidence, callback/watch readiness, owner decisions, activation evidence gates, callback/watch API shape, governance, and Android/Linux binding parity without transport selection, persistence, QoS activation, callback/watch registration, broker startup, SSE/WebSocket, DDS runtime, or high-rate data plane.",
