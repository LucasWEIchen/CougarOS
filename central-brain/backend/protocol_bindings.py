    ...
    def detail_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "constraints": [
                ...
                "The hardware empty-interface catalog is exposed at /hardware/interfaces, /hardware/interfaces/activation-checklist, and /hardware/interfaces/owner-decision-status for Android and Linux bindings; it records owner, ABI, Driver/HAL gap, safety policy, smoke-test, and rollback decision gates without opening devices, calling HALs, allocating shared memory, triggering Driver/HAL development, or performing virtualization work.",
            ],
