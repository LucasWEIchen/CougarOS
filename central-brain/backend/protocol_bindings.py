...
BINDING_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "semantic_paths": [
            "planned DDS delivery for /uib/events/topics, /uib/events/recent, and /uib/events/subscriptions high-rate topics",
        ],
        "artifacts": [],
    ...
    def detail_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "constraints": [
                ...
                "The Event subscription placeholder is exposed at /uib/events/subscriptions to fix lifecycle, cursor, backpressure, governance, and Android/Linux binding parity without starting a broker, SSE/WebSocket, DDS runtime, or high-rate data plane.",
