...
- `getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditDecisionRollupJson` exposes `GET /uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist/audit-consistency/decision-rollup` through the Android Console `Sub ApHRvRoll` action. It reports `EV-AHO-001..010`, `decision_rollup_complete=true`, `decision_rollup_consistent=true`, `reviewer_assignment_decision_blocked=true`, ten unassigned reviewers, zero persisted reviewer assignments, no reviewer assignment queue update, no review queue update, open gates, no broker activation, no Driver/HAL access, and no virtualization work. Req IDs: XSC-002, FW-U-003, XSC-005, XSC-006, NV-P-002, NV-P-003, NV-P-006, DEL-001, DEL-004.

## Event Subscription EV-AHP Closure Handoff Readiness Summary

- `getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditDecisionRollupClosureHandoffReadinessSummaryJson` exposes `GET /uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist/audit-consistency/decision-rollup/closure-handoff-readiness-summary` through the Android Console `Sub ApHReady` action. It reports `EV-AHP-001..010`, `closure_handoff_readiness_complete=true`, `closure_handoff_ready=false`, `handoff_ready=false`, `reviewer_assignment_decision_blocked=true`, ten open handoff dependencies, ten unassigned reviewers, zero persisted reviewer assignments, no reviewer assignment queue update, no review queue update, open gates, no broker activation, no Driver/HAL access, and no virtualization work. Req IDs: XSC-002, FW-U-003, XSC-005, XSC-006, NV-P-002, NV-P-003, NV-P-006, DEL-001, DEL-004.

## Event Subscription EV-AHQ Closure Handoff Readiness Audit Consistency

- `getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditDecisionRollupClosureHandoffReadinessAuditConsistencyJson` exposes `GET /uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist/audit-consistency/decision-rollup/closure-handoff-readiness-summary/audit-consistency` through the Android Console `Sub ApHReadyA` action. It reports `EV-AHQ-001..010`, `consistency_passed=true`, closure handoff dependency count and blocked state consistency, Android/Linux parity, no-store/no-POST/no-queue/gate/broker consistency, no Driver/HAL access, and no virtualization work. Req IDs: XSC-002, FW-U-003, XSC-005, XSC-006, NV-P-002, NV-P-003, NV-P-006, DEL-001, DEL-004.

## Event Subscription EV-AHR Closure Handoff Readiness Audit Decision Rollup

- `getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditDecisionRollupClosureHandoffReadinessAuditDecisionRollupJson` exposes `GET /uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist/audit-consistency/decision-rollup/closure-handoff-readiness-summary/audit-consistency/decision-rollup` through the Android Console `Sub ApHReadyR` action. It reports `EV-AHR-001..010`, `decision_rollup_complete=true`, `decision_rollup_consistent=true`, `closure_handoff_audit_decision_blocked=true`, `closure_handoff_audit_decision_ready=false`, ten blocked decisions, ten passed audit checks, no Driver/HAL access, and no virtualization work. Req IDs: XSC-002, FW-U-003, XSC-005, XSC-006, NV-P-002, NV-P-003, NV-P-006, DEL-001, DEL-004.
