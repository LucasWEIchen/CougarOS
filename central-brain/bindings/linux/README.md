...
`GetEventSubscriptionActivationApprovalDecisionDryRunAuditConsistency`, and
`GetEventSubscriptionActivationApprovalDecisionClosureBlockerMatrix` expose the same FW-U-003/NV-P-006
