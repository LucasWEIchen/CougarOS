...
`CentralBrainGateway.GetEventSubscriptions` exposes the same FW-U-003/NV-P-006
Event subscription placeholder contract as Android Binder and Linux IPC without
