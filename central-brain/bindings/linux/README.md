...
`GetEventSubscriptionActivationApprovalDryRunStatus`, and
`GetEventSubscriptionActivationApprovalAuthorityChecklist` expose the same FW-U-003/NV-P-006
...
approval dry-run status, approval authority checklist, activation evidence checklist, callback/watch API shape, cursor/replay storage,
