...
`GetEventSubscriptionActivationApprovalDryRunStatus` expose the same FW-U-003/NV-P-006
...
approval dry-run status, activation evidence checklist, callback/watch API shape, cursor/replay storage,
