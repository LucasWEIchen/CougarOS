...
| Model Runtime production | P7-W01 request/result v2 与 P7-W02 registry/health 已完成；仍需 PolicyAwareRouter、local/vendor/cloud provider 与 output validator | 下一步 P7-W03；Vendor/NPU 见 `ISSUE-024` | `IN_PROGRESS` |
