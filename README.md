...
| 模块 | 最小剩余工作 | 阻塞或下一步 | 状态 |
| --- | --- | --- | --- |
| 场景解析与仿真编排 | P2 foundation 与 P3-W01..W05 Graph/typed/checkpoint/retry/approval 已完成；仍需 Effect/recovery | Stage 2 P3-W06..W09 | `IN_PROGRESS` |
...
| Durable Agent Graph | P3-W01..W05 state+typed+checkpoint+retry+approval 已完成；仍需 Effect/Room/recovery/compensation | Stage 2 P3-W06..W09 | `IN_PROGRESS` |
