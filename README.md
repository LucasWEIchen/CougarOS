...
| 模块 | 最小剩余工作 | 阻塞或下一步 | 状态 |
| --- | --- | --- | --- |
| 场景解析与仿真编排 | P2 Signal/Capability/Twin/Context、manifest、resolver/compiler、simulated adapters/controller 已完成；仍需 durable Graph Runtime | Stage 2 P3-W01..W09 | `IN_PROGRESS` |
