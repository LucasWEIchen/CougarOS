...
| P9-W03 Security review/fuzz | AIDL/manifest/checkpoint/schema fuzz，caller spoof、replay、oversize、path traversal 和 signature policy | P9-W02 软件矩阵已完成；真实 72h 仍受 `ISSUE-049` 阻塞 | `NOT_STARTED` |
