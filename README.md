...
| 模块 | 最小剩余工作 | 阻塞或下一步 | 状态 |
| --- | --- | --- | --- |
| 场景解析与仿真编排 | Signal/Capability/Twin/Context、manifest catalog、resolver、typed Plan compiler、simulated base/HVAC/Seat/Media/Nav 已完成；仍需 debug controller 与 Graph Runtime | Stage 2 P2-W12..P3 | `IN_PROGRESS` |
