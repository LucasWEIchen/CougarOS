...
| 模块 | 最小剩余工作 | 阻塞或下一步 | 状态 |
| --- | --- | --- | --- |
| 场景解析与仿真编排 | P2 foundation 与 P3-W01..W04 Graph/typed/checkpoint/retry policy 已完成；仍需 approval/Effect/recovery | Stage 2 P3-W05..W09 | `IN_PROGRESS` |
...
| Durable Agent Graph | P3-W01..W04 state+typed+checkpoint+retry policy 已完成；仍需 approval/Effect/Room/recovery/compensation | Stage 2 P3-W05..W09 | `IN_PROGRESS` |
