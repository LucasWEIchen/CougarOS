...
flowchart TB
  ...
  Context -. "trusted source adapter pending" .-> TriggerEngineP6
...
P6-W01..P6-W04 状态：`event_broker_interface_defined=true`；`event_broker_typed_topics_verified=true`；
...
| Context source adapters | P6-W03 TriggerEngine 和 P6-W04 consent policy 均未接可信 observation source | 下一步 P6-W05；首批 Runtime health、simulated vehicle signal、time，真实 vehicle 后置 P8 | `IN_PROGRESS` |
...
| `central-brain/android-runtime/runtime-service/src/main/java/com/centralbrain/runtime/events` | Event/Trigger/Consent contract | R6 bounded runtime/readiness、P6-W01 typed EventBroker、P6-W02 Backpressure/QoS、P6-W03 suggestion-only TriggerEngine 与 P6-W04 policy-only exact grant；可信 source、durable state、production consent/Safety 和 Runtime 未接 |
