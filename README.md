...
flowchart TB
  ...
  CompensationUndo -. "Graph / Room / dispatch pending" .-> Effect
...
| 模块 | 最小剩余工作 | 阻塞或下一步 | 状态 |
| --- | --- | --- | --- |
| 场景解析与仿真编排 | P2 foundation 与 P3-W01..W08 Graph/typed/checkpoint/retry/approval/coordinator/verification/undo 已完成；仍需 restart recovery | Stage 2 P3-W09 | `IN_PROGRESS` |
...
| Durable Agent Graph | P3-W01..W08 state+typed+checkpoint+retry+approval+coordinator/verification/compensation 已完成；仍需 Room/restart recovery | Stage 2 P3-W09 | `IN_PROGRESS` |
