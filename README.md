...
| P9-W03 Security review/fuzz | W03a 三 parser/validator / 18-case regression 已完成；仍需 AIDL caller spoof/replay/signature、剩余 schema、Android probe 和受控 fuzz | 下一小步 P9-W03b；完整证据见 `DEV-088`、`ISSUE-050` | `IN_PROGRESS` |
