...
| P9-W04 Privacy/data lifecycle | W04a 已冻结 12 个 Android 数据面和两个 durable policy gap | W04b 需 owner-approved retention/delete/export policy；W04c 需 redaction/audit Android probe；见 `DEV-091`、`ISSUE-051` | `IN_PROGRESS` |
