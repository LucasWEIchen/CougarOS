...
flowchart TB
  ...
  GraphRuntime -. "executor / Room / Binder pending" .-> Services
  Domains --> Model
  Domains --> Effect
...
| 模块 | 最小剩余工作 | 阻塞或下一步 | 状态 |
| --- | --- | --- | --- |
| 场景解析与仿真编排 | P2 foundation 与 P3-W01 Graph 状态机已完成；仍需 typed executor/checkpoint/retry/Effect/recovery | Stage 2 P3-W02..W09 | `IN_PROGRESS` |
...
| Durable Agent Graph | P3-W01 process-local state 已完成；仍需 typed executor/checkpoint/Room/recovery/compensation | Stage 2 P3-W02..W09 | `IN_PROGRESS` |
