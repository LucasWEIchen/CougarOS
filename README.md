...
| 模块 | 最小剩余工作 | 阻塞或下一步 | 状态 |
| --- | --- | --- | --- |
| 场景解析与仿真编排 | Signal/Capability/Twin/Context、manifest catalog、resolver、typed Plan compiler、simulated base/HVAC/Seat 已完成；仍需 Media/Nav domain adapter 与 Graph Runtime | Stage 2 P2-W11..P3 | `IN_PROGRESS` |
