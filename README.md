...
| P9-W01 性能预算 | 建立启动、Binder、Session/Event、Graph、Effect、HMI、内存和功耗预算及可重复测量合同 | 可独立于 P8 外部输入推进 | `NOT_STARTED` |
...
| 日期 | 提交或版本 | 修改内容 | 状态边界 |
| --- | --- | --- | --- |
| 2026-07-18 | [P8-W01 Target Capability Discovery Preparation](docs/CENTRAL_BRAIN_TARGET_CAPABILITY_DISCOVERY.md) | 新增 14 列/8 能力机器合同、只读目标采集器、私有原始证据和 fake-ADB 脱敏校验 | 仅软件准备；未发现或调用 OEM service/property，P8-W01 保持 `EXTERNAL_BLOCKED`；独立下一步 P9-W01 |
