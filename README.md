...
| Model Runtime production | P7-W01 request/result v2、P7-W02 registry/health、P7-W03 PolicyAwareRouter 与 P7-W04 debug local provider 已完成；仍需 output schema、evaluation/resource composition 和 vendor/cloud production provider | 下一步 P7-W05；Vendor/NPU 见 `ISSUE-024` | `IN_PROGRESS` |
