...
| P9-W04 Privacy/data lifecycle | W04a 清单、W04b policy admission、W04c redacted debug probe 软件项已完成 | 仍需真实 owner ceiling/evidence、repository enforcement 和目标 probe；下一软件增量为 P9-W05；见 `DEV-091/092/093`、`ISSUE-051` | `EXTERNAL_BLOCKED` |
