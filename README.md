...
| 模块 | 最小剩余工作 | 阻塞或下一步 | 状态 |
| --- | --- | --- | --- |
| 场景解析与仿真编排 | P2 foundation 与 P3-W01..W03 Graph/typed/checkpoint contract 已完成；仍需 retry/Effect/recovery | Stage 2 P3-W04..W09 | `IN_PROGRESS` |
...
| Durable Agent Graph | P3-W01..W03 state+typed+checkpoint contract 已完成；仍需 retry/Room/recovery/compensation | Stage 2 P3-W04..W09 | `IN_PROGRESS` |
