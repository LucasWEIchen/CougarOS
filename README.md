...
| Tool/Skill runtime | P5-W01..W08 Tool/Skill、Working/Profile/Episodic Memory 合同已完成；可信 evidence、context budget 与量产 composition 未完成 | 下一步 P5-W09 ContextBudgetManager；owner 见 `ISSUE-040/041/042/043` | `IN_PROGRESS` |
...
| `central-brain/android-runtime/runtime-service/src/main/java/com/centralbrain/runtime/memory` | Memory contract | bounded lifecycle/readiness、P5-W06 WorkingMemoryStore、P5-W07 ProfileMemoryStore 与 P5-W08 typed summary-only EpisodicMemoryStore；均未持久化或发布 model context |
