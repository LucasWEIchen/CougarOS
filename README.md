...
| Model Runtime production | P7-W01 request/result v2、P7-W02 registry/health 与 P7-W03 PolicyAwareRouter 已完成；仍需 local/vendor/cloud provider、output validator 与 resource composition | 下一步 P7-W04；Vendor/NPU 见 `ISSUE-024` | `IN_PROGRESS` |
