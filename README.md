...
P5-W10 状态：`memory_consent_controller_defined=true`；`memory_consent_source_visibility_verified=true`；
...
| Event V2 cursor/ACK broker | terminal resume cursor、monotonic ACK、retention、backpressure | 下一步 P6-W01；P1-W07 仅完成独立 wire 演进决策 | `NOT_STARTED` |
