...
| 场景与仿真 Effect 编排 | P4-D4a 已组合 Compiler/AgentGraph 并验证 cold/fatigue 自动控制流；仍需 P4-D4b debug Runtime projection、adapter/readback 与 Client2 wiring | Stage 2 P4；不依赖真实车身信号 | `IN_PROGRESS` |
