...
| 模块 | 最小剩余工作 | 阻塞或下一步 | 状态 |
| --- | --- | --- | --- |
| 场景解析与仿真编排 | Signal/Capability/Twin/Context、manifest catalog、deterministic resolver 和 typed Plan compiler 已完成；仍需 debug Effect adapter 与 Graph Runtime | Stage 2 P2-W08..P3 | `IN_PROGRESS` |
