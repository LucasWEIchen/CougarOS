...
| P9-W07 Release evidence/diagnostics | W07a 已完成 metadata-only evidence envelope、八类 diagnostics 和稳定 report digest | W07b debug-only target probe/adapter 与 W07c replacement release/issue-retest workflow 待开发；target evidence/owner 见 `DEV-098`、`ISSUE-052/053`；下一软件增量为 P9-W07b | `IN_PROGRESS` |
