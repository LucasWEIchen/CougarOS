...
flowchart TB
  ...
  ToolRuleSolver -. "Runtime / Executor pending" .-> Domains
  Domains --> Twin
  Twin --> Context
...
| Tool/Skill runtime | P5-W01 manifest/schema、P5-W02 Registry/Resolver 与 P5-W03 RuleSolver 已完成；Executor/Skill artifact trust 未完成 | 下一步 P5-W04 ToolExecutor boundary；`S2-TOL-001`、`S2-SAF-001` | `IN_PROGRESS` |
