...
| ModelRequest/Result v2 | purpose、privacy、latency/token budget、capability、fallback、trace typed contract | 下一步 P7-W01 | `NOT_STARTED` |
