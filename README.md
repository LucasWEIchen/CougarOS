...
P6-W01..P6-W05 状态：`event_broker_interface_defined=true`；`event_broker_typed_topics_verified=true`；
...
| Active suggestion UX | why/cooldown/never ask、suggestion merge 与 moving minimal banner/voice 尚未开发 | 下一步 P6-W06 | `NOT_STARTED` |
