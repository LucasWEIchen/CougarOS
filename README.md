...
P6-W01/P6-W02 状态：`event_broker_interface_defined=true`；`event_broker_typed_topics_verified=true`；
...
| Event Broker production/durability | P6-W01 typed broker 与 P6-W02 process-local QoS 已完成；仍需 durable append/cursor transaction、broker composition 与 middleware publication | 下一步 P6-W03 Durable append/cursor integration；production owner 见 `ISSUE-046` | `IN_PROGRESS` |
...
| `central-brain/android-runtime/runtime-service/src/main/java/com/centralbrain/runtime/events` | Event contract | R6 bounded runtime/readiness、P6-W01 typed EventBroker/process-local append/replay 与 P6-W02 per-subscription Backpressure/QoS；broker composition、durable cursor repository、DDS/SOME-IP 和 production Runtime 未接 |
