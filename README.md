...
flowchart TB
  ...
  ToolContract -. "Registry / execution pending" .-> Domains
  Domains --> Twin
  Twin --> Context
...
| Tool/Skill runtime | P5-W01 manifest/schema 已完成；Registry/Resolver/RuleSolver/Executor/Skill artifact trust 未完成 | 下一步 P5-W02 ToolRegistry/Resolver；`S2-TOL-001` | `IN_PROGRESS` |
...
| `central-brain/android-runtime/runtime-service/src/main/java/com/centralbrain/runtime/tools` | Tool contract | P5-W01 immutable Tool manifest、bounded scalar input/output schema、canonical digest 与 exact validator；不注册、不执行 |
...
| `apk-labs/client2-central-brain/` | 座舱演示 HMI | `Client2ScenarioBridge`、`CockpitDisplayPolicy`、immutable HMI/device/execution/recovery/engineer state、唯一 reducer、四阶段 overlay、HVAC/Seat controls、七阶段执行 timeline、recovery/restriction、protected debug drawer 与 APK patch/build/test；已完成 P4-W12 Android 13 ARM64 聚合应用验收；下一步 P5-W01 Runtime 场景编排 |
