...
| P7-R3 Model Runtime production | P7-R2 开发网关与 `169.254.208.110` 接口设计完成；仍需 release Provider、health/version、model artifact 和 governed model-to-compiler composition | 实现项为 `PLANNED`；目标 NPU、可信 resource producer、链路安全和标定 owner 见 `ISSUE-024/044` | `PLANNED / EXTERNAL_VALIDATION` |
