...
| 场景与仿真 Effect 编排 | P4-D4a/D4b 已组合 Compiler/AgentGraph，并完成进程内 Session/Plan/Event 投影；仍需 P4-D4c debug Binder Service、adapter/readback 与 Client2 wiring | Stage 2 P4；不依赖真实车身信号 | `IN_PROGRESS` |
