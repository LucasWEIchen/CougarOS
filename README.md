...
| 场景与仿真 Effect 编排 | P4-D4a..D4d 已完成 Graph、进程内 projection、受保护 Binder 与 simulated adapter/readback composition；仍需 P4-D4e Client2 wiring | Stage 2 P4；不依赖真实车身信号 | `IN_PROGRESS` |
