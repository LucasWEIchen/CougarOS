...
flowchart TB
  ...
  Domains --> Model
  Domains --> Effect
  EffectCoordinator -. "outbox / verify / reconcile pending" .-> Effect
...
| 模块 | 最小剩余工作 | 阻塞或下一步 | 状态 |
| --- | --- | --- | --- |
| 场景解析与仿真编排 | P2 foundation 与 P3-W01..W06 Graph/typed/checkpoint/retry/approval/coordinator 已完成；仍需 verification/undo/recovery | Stage 2 P3-W07..W09 | `IN_PROGRESS` |
...
| Durable Agent Graph | P3-W01..W06 state+typed+checkpoint+retry+approval+coordinator 已完成；仍需 verification/Room/recovery/compensation | Stage 2 P3-W07..W09 | `IN_PROGRESS` |
| 场景与仿真 Effect 编排 | Coordinator foundation 已完成；仍需“我冷了/我累了”、simulated readback、reconcile、undo | Stage 2 P3-W07..W08/P4；不依赖真实车身信号 | `IN_PROGRESS` |
