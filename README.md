...
| Tool/Skill runtime | P5-W01..W07 Tool/Skill、Working/Profile Memory 合同已完成；可信 evidence、episodic memory 与量产 composition 未完成 | 下一步 P5-W08 EpisodicMemoryStore；owner 见 `ISSUE-040/041/042` | `IN_PROGRESS` |
...
| `central-brain/android-runtime/runtime-service/src/main/java/com/centralbrain/runtime/memory` | Memory contract | bounded lifecycle/readiness、P5-W06 WorkingMemoryStore 与 P5-W07 consent/field/user-seat ProfileMemoryStore；均未持久化或发布 model context |
