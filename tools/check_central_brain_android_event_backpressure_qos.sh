...
require_text "docs/CENTRAL_BRAIN_AIOS_STAGE2_DEVELOPMENT_BACKLOG.md" '`P6-W02` Backpressure/QoS'
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "P6-W02 Backpressure/QoS trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android P6-W02 Event Backpressure/QoS"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P6-W02 Event Backpressure/QoS architecture"
require_text "docs/CENTRAL_BRAIN_COMPLETE_SOFTWARE_DEVELOPMENT_DESIGN.md" "P6-W02 Event Backpressure/QoS detailed design"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android P6-W02 Event Backpressure/QoS"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "P6-W02 Event Backpressure/QoS Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "P6-W02 pressure queues remain process-local"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "P6-W02 Backpressure/QoS progress"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "P6-W02 Backpressure/QoS"
