...
require_text "docs/CENTRAL_BRAIN_ANDROID_RUNTIME_EVOLUTION_PLAN.md" "R4B2 durable Runtime wiring"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "R4B2 durable Runtime wiring trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android R4B2 Durable Runtime Wiring"
...
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "R4B2 进展"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "R4B2 进展"
