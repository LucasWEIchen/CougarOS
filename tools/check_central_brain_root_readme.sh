...
if "P6-W05" not in remaining or "Context source adapters" not in remaining:
    raise SystemExit("README remaining-work table must identify P6-W05 Context source adapters as the next unfinished scope")
