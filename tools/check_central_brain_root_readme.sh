...
if "P6-W04" not in remaining or "Proactive consent/policy" not in remaining:
    raise SystemExit("README remaining-work table must identify P6-W04 Proactive consent/policy as the next unfinished scope")
