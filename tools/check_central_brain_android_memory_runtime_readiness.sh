...
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "R6B2 Memory runtime readiness"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6B2 Memory runtime readiness trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R6B2 Memory Runtime Readiness"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android R6B2 Memory Runtime Readiness"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6B2 Memory Readiness Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6B2 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6B2 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6B2 Memory runtime readiness"
