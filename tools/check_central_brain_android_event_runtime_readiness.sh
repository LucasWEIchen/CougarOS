...
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "R6A3 Event runtime readiness"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6A3 Event runtime readiness trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R6A3 Event Runtime Readiness"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android R6A3 Event Runtime Readiness"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6A3 Event Readiness Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6A3 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6A3 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6A3 Event runtime readiness"
