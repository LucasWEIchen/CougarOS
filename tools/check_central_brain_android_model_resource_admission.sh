...
require_text "docs/CENTRAL_BRAIN_AIOS_STAGE2_DEVELOPMENT_BACKLOG.md" '`P7-W07` Resource/thermal admission'
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "P7-W07 resource and thermal admission trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android P7-W07 Resource and Thermal Admission"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P7-W07 resource and thermal admission architecture"
require_text "docs/CENTRAL_BRAIN_COMPLETE_SOFTWARE_DEVELOPMENT_DESIGN.md" "P7-W07 resource and thermal admission detailed design"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android P7-W07 Resource and Thermal Admission"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "P7-W07 Resource and Thermal Admission Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "P7-W07 admission uses caller-owned resource metadata"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "P7-W07 Resource and Thermal Admission progress"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "P7-W07 Resource and Thermal Admission progress"
