...
require_text "docs/CENTRAL_BRAIN_AIOS_STAGE2_DEVELOPMENT_BACKLOG.md" '`P7-W06` Scenario evaluation harness'
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "P7-W06 scenario evaluation trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android P7-W06 Scenario Evaluation Harness"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P7-W06 scenario evaluation architecture"
require_text "docs/CENTRAL_BRAIN_COMPLETE_SOFTWARE_DEVELOPMENT_DESIGN.md" "P7-W06 scenario evaluation detailed design"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android P7-W06 Scenario Evaluation Harness"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "P7-W06 Scenario Evaluation Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "P7-W06 evaluator is offline and digest-only"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "P7-W06 Scenario Evaluation progress"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "P7-W06 Scenario Evaluation progress"
