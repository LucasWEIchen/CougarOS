...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P6-W05` Context source adapters'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W05 Context source adapters trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P6-W05 Context source adapters"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P6-W05 Context source adapters architecture"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "P6-W05 Context source adapters detailed design"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P6-W05 Context source adapters"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W05 Context source adapters Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W05 Context source adapters are contracts, not production providers"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W05 Context source adapters progress"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W05 Context source adapters progress"
