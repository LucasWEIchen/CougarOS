...
require_text "docs/CENTRAL_BRAIN_ANDROID_RUNTIME_EVOLUTION_PLAN.md" "R4C3B effect material source and activation gate"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "R4C3B effect material activation trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android R4C3B Effect Material Activation Gate"
...
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "R4C3B 进展"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "R4C3B 进展"
