...
require_text "docs/CENTRAL_BRAIN_AIOS_STAGE2_DEVELOPMENT_BACKLOG.md" '`P7-W05` Prompt/Output schema'
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "P7-W05 structured model output trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android P7-W05 Structured Model Output"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P7-W05 structured model output architecture"
require_text "docs/CENTRAL_BRAIN_COMPLETE_SOFTWARE_DEVELOPMENT_DESIGN.md" "P7-W05 structured model output detailed design"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android P7-W05 Structured Model Output"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "P7-W05 Structured Model Output Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "P7-W05 model output is proposal-only"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "P7-W05 Structured Model Output progress"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "P7-W05 Structured Model Output progress"
