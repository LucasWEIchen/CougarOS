...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P6-W01` EventBroker interface/in-process implementation'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W01 EventBroker interface/in-process implementation trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P6-W01 EventBroker interface/in-process implementation"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P6-W01 EventBroker interface/in-process architecture"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "P6-W01 EventBroker interface/in-process detailed design"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P6-W01 EventBroker interface/in-process implementation"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W01 EventBroker Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "DEV-073 P6-W01 process-local Event Broker is not durable middleware"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "ISSUE-046 Event Broker durable repository and production middleware publication"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W01 EventBroker interface/in-process implementation"
