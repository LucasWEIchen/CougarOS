...
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Gradle application structured AIDL"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "not VINTF stable AIDL"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "DEV-018"
