...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'P9-W03b identity/replay/signer policy corpus'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'P9-W03b identity/replay security corpus trace'
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" 'Android P9-W03b Identity/Replay Security Corpus Contract'
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" 'P9-W03b identity/replay security corpus architecture'
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" 'P9-W03b identity/replay security corpus detailed design'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'Android P9-W03b Identity/Replay Security Corpus'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'P9-W03b Identity/Replay Security Driver/HAL Boundary'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'DEV-089 P9-W03b host policy corpus is not Binder or APK crypto evidence'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'ISSUE-050 P9 complete security fuzz evidence is unavailable'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'P9-W03b Identity/Replay Security Corpus progress'
