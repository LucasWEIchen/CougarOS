...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P6-W03` TriggerRule manifest/engine'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W03 TriggerRule manifest/engine trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P6-W03 TriggerRule manifest/engine"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P6-W03 TriggerEngine architecture"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "P6-W03 TriggerRule/TriggerEngine detailed design"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P6-W03 TriggerRule manifest/engine"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W03 TriggerEngine Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W03 process-local TriggerEngine is not production proactive intelligence"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W03 TriggerEngine progress"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P6-W03 TriggerRule manifest/engine progress"
