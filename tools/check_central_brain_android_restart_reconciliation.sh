...
require_text "docs/CENTRAL_BRAIN_ANDROID_RUNTIME_EVOLUTION_PLAN.md" "R4C1 fail-closed restart reconciliation"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "R4C1 fail-closed restart reconciliation trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android R4C1 Fail-Closed Restart Reconciliation"
...
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "R4C1 进展"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "R4C1 进展"
