...
require_text "docs/CENTRAL_BRAIN_AIOS_STAGE2_DEVELOPMENT_BACKLOG.md" '`P2-W03` Vehicle Digital Twin store'
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "P2-W03 Vehicle Digital Twin Store trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android P2-W03 Vehicle Digital Twin Store"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android P2-W03 Vehicle Digital Twin Store"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "P2-W03 Digital Twin Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "P2-W03 进展"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "P2-W03 进展"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "P2-W03 VehicleDigitalTwinStore"
