...
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "R6A2A durable Event schema"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6A2A durable Event schema trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R6A2A Durable Event Schema"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android R6A2A Durable Event Schema"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6A2A Event Schema Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6A2A 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6A2A 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6A2A durable Event schema"
