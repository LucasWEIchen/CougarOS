...
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "R5B2 test-only model router"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5B2 test-only model router trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R5B2 Test-Only Model Router"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android R5B2 Test-Only Model Router"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5B2 Test-Only Router Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R5B2 Test-Only Model Router"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5B2 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5B2 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5B2 test-only model router"
