...
for doc_marker in \
  ...
  'docs/CENTRAL_BRAIN_REQUIREMENTS.md|P4-W05' \
  'docs/CENTRAL_BRAIN_REQUIREMENTS.md|P4-W05 Seat control surface trace' \
  'docs/CENTRAL_BRAIN_REQUIREMENTS.md|DEV-055' \
  'docs/CENTRAL_BRAIN_REQUIREMENTS.md|P4-W05 进展' \
  'docs/CENTRAL_BRAIN_REQUIREMENTS.md|P4-W05 Seat Control Surface' \
  'docs/CENTRAL_BRAIN_REQUIREMENTS.md|P4-W05 Seat control surface Driver/HAL Boundary'; do
  path="${doc_marker%%|*}"
  marker="${doc_marker#*|}"
