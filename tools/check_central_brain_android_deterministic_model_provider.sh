...
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "R5B1 deterministic stub provider"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5B1 deterministic stub provider trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R5B1 Deterministic Stub Provider"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android R5B1 Deterministic Stub Provider"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5B1 Deterministic Provider Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5B1 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5B1 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5B1 deterministic stub provider"
