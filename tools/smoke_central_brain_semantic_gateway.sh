...
checks = [
    ...
    ("GET", "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist", None, "NV-P-006"),
    ...
    ("GET", "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist/audit-consistency/decision-rollup/closure-handoff-readiness-summary/audit-consistency/decision-rollup", None, "NV-P-006"),
    ("GET", "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist/audit-consistency/decision-rollup/closure-handoff-readiness-summary/audit-consistency/decision-rollup/closure-blocker-matrix", None, "NV-P-006"),
...
for method, path, body, req_id in checks:
    ...
    if path == "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist":
        handoff = payload["payload"]
        encoded = json.dumps(handoff)
        gate_ids = {item["gate_id"] for item in handoff["mandatory_gates"]}
        assert handoff["operation"] == "event-subscription-activation-approval-decision-owner-handoff-checklist", "activation approval decision owner handoff checklist operation mismatch"
        assert handoff["approval_decision_owner_handoff_checklist_state"] == "contract-only-owner-handoff-blocked", "activation approval decision owner handoff checklist wrong state"
        assert handoff["approval_decision_owner_handoff_checklist_active"] is True, "activation approval decision owner handoff checklist inactive"
        assert {"EV-ACH-001", "EV-ACH-002", "EV-ACH-003", "EV-ACH-004", "EV-ACH-005", "EV-ACH-006", "EV-ACH-007", "EV-ACH-008", "EV-ACH-009", "EV-ACH-010"} <= gate_ids, "activation approval decision owner handoff checklist missing EV-ACH gates"
        source = handoff["source_surfaces"]["closure_blocker_matrix"]
        assert source["active"] is True, "activation approval decision owner handoff checklist source closure matrix inactive"
        assert source["complete"] is True, "activation approval decision owner handoff checklist source closure matrix incomplete"
        assert source["closure_ready"] is False, "activation approval decision owner handoff checklist source closure unexpectedly ready"
        assert source["open_closure_blocker_count"] == 10, "activation approval decision owner handoff checklist source blocker count changed"
        assert "EV-ACB-010" in source["open_closure_blocker_ids"], "activation approval decision owner handoff checklist missing source EV-ACB blocker"
        assert len(handoff["owner_handoffs"]) == 10, "activation approval decision owner handoff checklist handoff count changed"
        for item in handoff["owner_handoffs"]:
            assert item["handoff_state"] == "owner-unassigned", f"activation approval decision owner handoff unexpectedly assigned {item['handoff_id']}"
            assert item["escalation_state"] == "blocked-waiting-owner-assignment", f"activation approval decision owner handoff escalation changed {item['handoff_id']}"
            assert item["android_linux_parity_required"] is True, f"activation approval decision owner handoff missing parity requirement {item['handoff_id']}"
            for key in [
                "handoff_ready",
                "owner_assigned",
                "evidence_attached",
                ...
                assert item[key] is False, f"activation approval decision owner handoff unexpectedly set {key} for {item['handoff_id']}"
            assert item["open"] is True, f"activation approval decision owner handoff unexpectedly closed {item['handoff_id']}"
        for key in [
            ...
            assert handoff["summary"][key] is True, f"activation approval decision owner handoff checklist summary did not set {key}"
        for key in [
            ...
            assert handoff["summary"][key] is False, f"activation approval decision owner handoff checklist summary unexpectedly set {key}"
        assert handoff["summary"]["owner_handoff_checklist_state"] == "contract-only-owner-handoff-blocked", "activation approval decision owner handoff checklist summary wrong state"
        assert handoff["summary"]["source_open_closure_blocker_count"] == 10, "activation approval decision owner handoff checklist source count changed"
        assert handoff["summary"]["required_owner_handoff_count"] == 10, "activation approval decision owner handoff checklist required count changed"
        assert handoff["summary"]["open_owner_handoff_count"] == 10, "activation approval decision owner handoff checklist open count changed"
        assert handoff["summary"]["assigned_owner_count"] == 0, "activation approval decision owner handoff checklist assigned owners changed"
        assert handoff["summary"]["unassigned_owner_count"] == 10, "activation approval decision owner handoff checklist unassigned owners changed"
        assert handoff["summary"]["attached_evidence_count"] == 0, "activation approval decision owner handoff checklist attached evidence changed"
        assert handoff["summary"]["persisted_dry_run_request_count"] == 0, "activation approval decision owner handoff checklist persisted requests"
        assert handoff["summary"]["persisted_dry_run_result_count"] == 0, "activation approval decision owner handoff checklist persisted results"
        assert handoff["summary"]["persisted_approval_decision_count"] == 0, "activation approval decision owner handoff checklist persisted decisions"
        assert handoff["summary"]["pending_approval_decision_review_count"] == 0, "activation approval decision owner handoff checklist queued reviews"
        assert "getEventSubscriptionActivationApprovalDecisionOwnerHandoffChecklistJson" in encoded, "Android activation approval decision owner handoff checklist binding missing"
        assert "event-subscription-activation-approval-decision-owner-handoff-checklist" in encoded, "Linux CLI activation approval decision owner handoff checklist binding missing"
        assert "uib.events.subscriptions.activation.approval.decision.owner.handoff.checklist" in encoded, "Linux IPC activation approval decision owner handoff checklist binding missing"
        assert "GetEventSubscriptionActivationApprovalDecisionOwnerHandoffChecklist" in encoded, "gRPC activation approval decision owner handoff checklist binding missing"
    ...
    if path == "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup":
        rollup = payload["payload"]
        encoded = json.dumps(rollup)
        gate_ids = {item["gate_id"] for item in rollup["mandatory_gates"]}
        assert rollup["operation"] == "event-subscription-activation-approval-decision-owner-handoff-decision-rollup", "activation approval decision owner handoff decision rollup operation mismatch"
        assert rollup["approval_decision_owner_handoff_decision_rollup_state"] == "contract-only-owner-handoff-decision-blocked", "activation approval decision owner handoff decision rollup wrong state"
        assert rollup["approval_decision_owner_handoff_decision_rollup_active"] is True, "activation approval decision owner handoff decision rollup inactive"
        assert {"EV-AHD-001", "EV-AHD-002", "EV-AHD-003", "EV-AHD-004", "EV-AHD-005", "EV-AHD-006", "EV-AHD-007", "EV-AHD-008", "EV-AHD-009", "EV-AHD-010"} <= gate_ids, "activation approval decision owner handoff decision rollup missing EV-AHD gates"
        ...
        assert audit_source["active"] is True and audit_source["consistent"] is True, "activation approval decision owner handoff decision rollup audit source not bound"
        assert audit_source["owner_handoff_ready"] is False, "activation approval decision owner handoff decision rollup audit source unexpectedly ready"
        assert checklist_source["active"] is True and checklist_source["complete"] is True, "activation approval decision owner handoff decision rollup checklist source not bound"
        assert checklist_source["owner_handoff_ready"] is False, "activation approval decision owner handoff decision rollup checklist source unexpectedly ready"
        assert "EV-ACH-010" in audit_source["open_owner_handoff_ids"], "activation approval decision owner handoff decision rollup missing audit source EV-ACH"
        assert "EV-ACH-010" in checklist_source["open_owner_handoff_ids"], "activation approval decision owner handoff decision rollup missing checklist source EV-ACH"
        assert len(rollup["decision_items"]) == 10, "activation approval decision owner handoff decision rollup decision item count changed"
        for item in rollup["decision_items"]:
            assert item["decision_state"] == "blocked", f"activation approval decision owner handoff decision item state changed {item['gate_id']}"
            assert item["decision_blocked"] is True, f"activation approval decision owner handoff decision item unexpectedly unblocked {item['gate_id']}"
            assert item["open"] is True, f"activation approval decision owner handoff decision item unexpectedly closed {item['gate_id']}"
            for key in ["owner_assigned", "evidence_attached", "review_queue_updated"]:
                assert item[key] is False, f"activation approval decision owner handoff decision item unexpectedly set {key} for {item['gate_id']}"
            assert item["source_handoff_id"].startswith("EV-ACH-"), f"activation approval decision owner handoff decision item missing source handoff {item['gate_id']}"
            assert item["source_blocker_id"].startswith("EV-ACB-"), f"activation approval decision owner handoff decision item missing source blocker {item['gate_id']}"
        for key in [
            ...
            assert rollup["summary"][key] is True, f"activation approval decision owner handoff decision rollup summary did not set {key}"
        for key in [
            ...
            assert rollup["summary"][key] is False, f"activation approval decision owner handoff decision rollup summary unexpectedly set {key}"
        assert rollup["summary"]["owner_handoff_decision_rollup_state"] == "contract-only-owner-handoff-decision-blocked", "activation approval decision owner handoff decision rollup summary wrong state"
        assert rollup["summary"]["decision"] == "blocked-by-unassigned-owners-and-missing-evidence", "activation approval decision owner handoff decision rollup decision changed"
        assert rollup["summary"]["required_decision_count"] == 10, "activation approval decision owner handoff decision rollup required decision count changed"
        assert rollup["summary"]["blocked_decision_count"] == 10, "activation approval decision owner handoff decision rollup blocked decision count changed"
        assert rollup["summary"]["required_owner_handoff_count"] == 10, "activation approval decision owner handoff decision rollup required handoff count changed"
        assert rollup["summary"]["open_owner_handoff_count"] == 10, "activation approval decision owner handoff decision rollup open handoff count changed"
        assert rollup["summary"]["assigned_owner_count"] == 0, "activation approval decision owner handoff decision rollup assigned owners changed"
        assert rollup["summary"]["unassigned_owner_count"] == 10, "activation approval decision owner handoff decision rollup unassigned owners changed"
        assert rollup["summary"]["attached_evidence_count"] == 0, "activation approval decision owner handoff decision rollup attached evidence changed"
        assert rollup["summary"]["persisted_dry_run_request_count"] == 0, "activation approval decision owner handoff decision rollup persisted requests"
        assert rollup["summary"]["persisted_dry_run_result_count"] == 0, "activation approval decision owner handoff decision rollup persisted results"
        assert rollup["summary"]["persisted_approval_decision_count"] == 0, "activation approval decision owner handoff decision rollup persisted decisions"
        assert rollup["summary"]["pending_approval_decision_review_count"] == 0, "activation approval decision owner handoff decision rollup queued reviews"
        assert "getEventSubscriptionActivationApprovalDecisionOwnerHandoffDecisionRollupJson" in encoded, "Android activation approval decision owner handoff decision rollup binding missing"
        assert "event-subscription-activation-approval-decision-owner-handoff-decision-rollup" in encoded, "Linux CLI activation approval decision owner handoff decision rollup binding missing"
        assert "uib.events.subscriptions.activation.approval.decision.owner.handoff.decision.rollup" in encoded, "Linux IPC activation approval decision owner handoff decision rollup binding missing"
        assert "GetEventSubscriptionActivationApprovalDecisionOwnerHandoffDecisionRollup" in encoded, "gRPC activation approval decision owner handoff decision rollup binding missing"
    ...
    if path == "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency":
        audit = payload["payload"]
        encoded = json.dumps(audit)
        gate_ids = {item["gate_id"] for item in audit["mandatory_gates"]}
        assert audit["operation"] == "event-subscription-activation-approval-decision-owner-handoff-evidence-readiness-audit-consistency", "activation approval decision owner handoff evidence readiness audit operation mismatch"
        assert audit["approval_decision_owner_handoff_evidence_readiness_audit_consistency_state"] == "contract-only-handoff-evidence-audit-consistent", "activation approval decision owner handoff evidence readiness audit wrong state"
        assert audit["approval_decision_owner_handoff_evidence_readiness_audit_consistency_active"] is True, "activation approval decision owner handoff evidence readiness audit inactive"
        assert {"EV-AHF-001", "EV-AHF-002", "EV-AHF-003", "EV-AHF-004", "EV-AHF-005", "EV-AHF-006", "EV-AHF-007", "EV-AHF-008", "EV-AHF-009", "EV-AHF-010"} <= gate_ids, "activation approval decision owner handoff evidence readiness audit missing EV-AHF gates"
        ...
        assert matrix_source["active"] is True and matrix_source["complete"] is True and matrix_source["consistent"] is True, "activation approval decision owner handoff evidence readiness audit matrix source not bound"
        assert matrix_source["handoff_evidence_ready"] is False, "activation approval decision owner handoff evidence readiness audit source unexpectedly ready"
        assert rollup_source["active"] is True and rollup_source["complete"] is True and rollup_source["consistent"] is True, "activation approval decision owner handoff evidence readiness audit rollup source not bound"
        assert rollup_source["decision_blocked"] is True, "activation approval decision owner handoff evidence readiness audit rollup unexpectedly unblocked"
        assert len(audit["audit_items"]) == 10, "activation approval decision owner handoff evidence readiness audit item count changed"
        for item in audit["audit_items"]:
            assert item["result"] == "consistent", f"activation approval decision owner handoff evidence readiness audit item not consistent {item['gate_id']}"
            assert item["passed"] is True, f"activation approval decision owner handoff evidence readiness audit item not passed {item['gate_id']}"
            assert item["readiness_still_blocked"] is True, f"activation approval decision owner handoff evidence readiness audit item lost blocked state {item['gate_id']}"
            assert item["source_evidence_id"].startswith("EV-AHE-"), f"activation approval decision owner handoff evidence readiness audit source evidence missing {item['gate_id']}"
            assert item["source_decision_gate_id"].startswith("EV-AHD-"), f"activation approval decision owner handoff evidence readiness audit source decision missing {item['gate_id']}"
            assert item["source_handoff_id"].startswith("EV-ACH-"), f"activation approval decision owner handoff evidence readiness audit source handoff missing {item['gate_id']}"
            assert item["source_blocker_id"].startswith("EV-ACB-"), f"activation approval decision owner handoff evidence readiness audit source blocker missing {item['gate_id']}"
        for key in [
            ...
            assert audit["summary"][key] is True, f"activation approval decision owner handoff evidence readiness audit summary did not set {key}"
        for key in [
            "handoff_evidence_ready",
            "approval_decision_ready",
            "approval_dry_run_allowed",
            ...
            assert audit["summary"][key] is False, f"activation approval decision owner handoff evidence readiness audit summary unexpectedly set {key}"
        assert audit["summary"]["handoff_evidence_readiness_audit_consistency_state"] == "contract-only-handoff-evidence-audit-consistent", "activation approval decision owner handoff evidence readiness audit summary wrong state"
        assert audit["summary"]["decision"] == "blocked-by-missing-handoff-evidence-packets", "activation approval decision owner handoff evidence readiness audit decision changed"
        assert audit["summary"]["required_evidence_packet_count"] == 10, "activation approval decision owner handoff evidence readiness audit required packet count changed"
        assert audit["summary"]["missing_evidence_packet_count"] == 10, "activation approval decision owner handoff evidence readiness audit missing packet count changed"
        assert audit["summary"]["attached_evidence_count"] == 0, "activation approval decision owner handoff evidence readiness audit attached evidence changed"
        assert audit["summary"]["persisted_evidence_packet_count"] == 0, "activation approval decision owner handoff evidence readiness audit persisted evidence changed"
        assert audit["summary"]["evidence_uri_count"] == 0, "activation approval decision owner handoff evidence readiness audit evidence URI count changed"
        assert audit["summary"]["evidence_hash_count"] == 0, "activation approval decision owner handoff evidence readiness audit evidence hash count changed"
        assert audit["summary"]["owner_signature_count"] == 0, "activation approval decision owner handoff evidence readiness audit owner signature count changed"
        assert audit["summary"]["required_owner_handoff_count"] == 10, "activation approval decision owner handoff evidence readiness audit required handoff count changed"
        assert audit["summary"]["open_owner_handoff_count"] == 10, "activation approval decision owner handoff evidence readiness audit open handoff count changed"
        assert audit["summary"]["assigned_owner_count"] == 0, "activation approval decision owner handoff evidence readiness audit assigned owners changed"
        assert audit["summary"]["unassigned_owner_count"] == 10, "activation approval decision owner handoff evidence readiness audit unassigned owners changed"
        assert audit["summary"]["persisted_dry_run_request_count"] == 0, "activation approval decision owner handoff evidence readiness audit persisted requests"
        assert audit["summary"]["persisted_dry_run_result_count"] == 0, "activation approval decision owner handoff evidence readiness audit persisted results"
        assert audit["summary"]["persisted_approval_decision_count"] == 0, "activation approval decision owner handoff evidence readiness audit persisted decisions"
        assert audit["summary"]["pending_approval_decision_review_count"] == 0, "activation approval decision owner handoff evidence readiness audit queued reviews"
        assert "getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceReadinessAuditConsistencyJson" in encoded, "Android activation approval decision owner handoff evidence readiness audit binding missing"
        assert "event-subscription-activation-approval-decision-owner-handoff-evidence-readiness-audit-consistency" in encoded, "Linux CLI activation approval decision owner handoff evidence readiness audit binding missing"
        assert "uib.events.subscriptions.activation.approval.decision.owner.handoff.evidence.readiness.audit.consistency" in encoded, "Linux IPC activation approval decision owner handoff evidence readiness audit binding missing"
        assert "GetEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceReadinessAuditConsistency" in encoded, "gRPC activation approval decision owner handoff evidence readiness audit binding missing"
    ...
    if path == "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist":
        ...
        encoded = json.dumps(checklist)
        gate_ids = {item["gate_id"] for item in checklist["mandatory_gates"]}
        assert checklist["operation"] == "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-checklist", "activation approval decision owner handoff evidence acceptance closure readiness wrong operation"
        assert checklist["approval_decision_owner_handoff_evidence_acceptance_closure_readiness_checklist_state"] == "contract-only-handoff-evidence-acceptance-closure-not-ready", "activation approval decision owner handoff evidence acceptance closure readiness wrong state"
        assert checklist["approval_decision_owner_handoff_evidence_acceptance_closure_readiness_checklist_active"] is True, "activation approval decision owner handoff evidence acceptance closure readiness inactive"
        assert checklist["closure_readiness_checklist_complete"] is True, "activation approval decision owner handoff evidence acceptance closure readiness incomplete"
        assert checklist["closure_readiness_consistent"] is True, "activation approval decision owner handoff evidence acceptance closure readiness inconsistent"
        assert checklist["source_surfaces_bound"] is True, "activation approval decision owner handoff evidence acceptance closure readiness source surfaces unbound"
        assert checklist["closure_ready"] is False, "activation approval decision owner handoff evidence acceptance closure readiness unexpectedly ready"
        assert {"EV-AHJ-001", "EV-AHJ-002", "EV-AHJ-003", "EV-AHJ-004", "EV-AHJ-005", "EV-AHJ-006", "EV-AHJ-007", "EV-AHJ-008", "EV-AHJ-009", "EV-AHJ-010"} <= gate_ids, "activation approval decision owner handoff evidence acceptance closure readiness missing EV-AHJ gates"
        assert len(checklist["closure_items"]) == 10, "activation approval decision owner handoff evidence acceptance closure readiness item count changed"
        for item in checklist["closure_items"]:
            assert item["ready"] is False, f"activation approval decision owner handoff evidence acceptance closure readiness item unexpectedly ready {item['gate_id']}"
            assert item["blocks_gate_closure"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness lost gate block {item['gate_id']}"
            assert item["blocks_broker_activation"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness lost broker block {item['gate_id']}"
            assert item["source_decision_gate_id"].startswith("EV-AHI-"), f"activation approval decision owner handoff evidence acceptance closure readiness missing EV-AHI source {item['gate_id']}"
            assert item["source_acceptance_gate_id"].startswith("EV-AHG-"), f"activation approval decision owner handoff evidence acceptance closure readiness missing EV-AHG source {item['gate_id']}"
            assert item["source_audit_gate_id"].startswith("EV-AHH-"), f"activation approval decision owner handoff evidence acceptance closure readiness missing EV-AHH source {item['gate_id']}"
            assert item["source_evidence_id"].startswith("EV-AHE-"), f"activation approval decision owner handoff evidence acceptance closure readiness missing EV-AHE source {item['gate_id']}"
        for key in [
            ...
            assert checklist["summary"][key] is True, f"activation approval decision owner handoff evidence acceptance closure readiness summary did not set {key}"
        for key in [
            "closure_ready",
            "closure_allowed",
            "approval_review_allowed",
            ...
            assert checklist["summary"][key] is False, f"activation approval decision owner handoff evidence acceptance closure readiness summary unexpectedly set {key}"
        assert checklist["summary"]["required_closure_check_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness required count changed"
        assert checklist["summary"]["open_closure_check_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness open count changed"
        assert checklist["summary"]["blocked_decision_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness blocked decision count changed"
        assert checklist["summary"]["blocked_acceptance_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness blocked acceptance count changed"
        assert checklist["summary"]["accepted_evidence_packet_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness accepted packet count changed"
        assert checklist["summary"]["acceptance_record_persisted_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness persisted record count changed"
        assert checklist["summary"]["missing_evidence_packet_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness missing packet count changed"
        assert "getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessChecklistJson" in encoded, "Android activation approval decision owner handoff evidence acceptance closure readiness binding missing"
        assert "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-checklist" in encoded, "Linux CLI activation approval decision owner handoff evidence acceptance closure readiness binding missing"
        assert "uib.events.subscriptions.activation.approval.decision.owner.handoff.evidence.acceptance.closure.readiness.checklist" in encoded, "Linux IPC activation approval decision owner handoff evidence acceptance closure readiness binding missing"
        assert "GetEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessChecklist" in encoded, "gRPC activation approval decision owner handoff evidence acceptance closure readiness binding missing"
        assert "EV-AHJ-001" in encoded and "EV-AHJ-010" in encoded and "EV-AHI-010" in encoded and "EV-AHH-010" in encoded and "EV-AHG-010" in encoded and "EV-AHE-010" in encoded, "activation approval decision owner handoff evidence acceptance closure readiness missing gate references"
        assert "DRV-GAP-004" in encoded and "DRV-GAP-005" in encoded, "activation approval decision owner handoff evidence acceptance closure readiness missing Driver/HAL gap references"
        assert "NV-P-006" in encoded and "FW-U-003" in encoded and "DEL-004" in encoded, "event subscription activation approval decision owner handoff evidence acceptance closure readiness missing Req IDs"
    if path == "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency":
        ...
        encoded = json.dumps(audit)
        gate_ids = {item["gate_id"] for item in audit["mandatory_gates"]}
        assert audit["operation"] == "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-audit-consistency", "activation approval decision owner handoff evidence acceptance closure readiness audit wrong operation"
        assert audit["approval_decision_owner_handoff_evidence_acceptance_closure_readiness_audit_consistency_state"] == "contract-only-handoff-evidence-acceptance-closure-audit-consistent", "activation approval decision owner handoff evidence acceptance closure readiness audit wrong state"
        assert audit["approval_decision_owner_handoff_evidence_acceptance_closure_readiness_audit_consistency_active"] is True, "activation approval decision owner handoff evidence acceptance closure readiness audit inactive"
        assert audit["consistency_passed"] is True, "activation approval decision owner handoff evidence acceptance closure readiness audit did not pass consistency"
        assert {"EV-AHK-001", "EV-AHK-002", "EV-AHK-003", "EV-AHK-004", "EV-AHK-005", "EV-AHK-006", "EV-AHK-007", "EV-AHK-008", "EV-AHK-009", "EV-AHK-010"} <= gate_ids, "activation approval decision owner handoff evidence acceptance closure readiness audit missing EV-AHK gates"
        assert len(audit["audit_items"]) == 10, "activation approval decision owner handoff evidence acceptance closure readiness audit item count changed"
        for item in audit["audit_items"]:
            assert item["passed"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness audit gate failed {item['gate_id']}"
            assert item["closure_still_blocked"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness audit lost closure block {item['gate_id']}"
            assert item["source_closure_gate_id"].startswith("EV-AHJ-"), f"activation approval decision owner handoff evidence acceptance closure readiness audit missing EV-AHJ source {item['gate_id']}"
            assert item["source_decision_gate_id"].startswith("EV-AHI-"), f"activation approval decision owner handoff evidence acceptance closure readiness audit missing EV-AHI source {item['gate_id']}"
            assert item["source_acceptance_gate_id"].startswith("EV-AHG-"), f"activation approval decision owner handoff evidence acceptance closure readiness audit missing EV-AHG source {item['gate_id']}"
            assert item["source_audit_gate_id"].startswith("EV-AHH-"), f"activation approval decision owner handoff evidence acceptance closure readiness audit missing EV-AHH source {item['gate_id']}"
            assert item["source_evidence_id"].startswith("EV-AHE-"), f"activation approval decision owner handoff evidence acceptance closure readiness audit missing EV-AHE source {item['gate_id']}"
        for key in [
            ...
            assert audit["summary"][key] is True, f"activation approval decision owner handoff evidence acceptance closure readiness audit summary did not set {key}"
        for key in [
            "closure_ready",
            "closure_allowed",
            "approval_review_allowed",
            ...
            assert audit["summary"][key] is False, f"activation approval decision owner handoff evidence acceptance closure readiness audit summary unexpectedly set {key}"
        assert audit["summary"]["required_audit_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness audit required audit count changed"
        assert audit["summary"]["required_closure_check_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness audit required closure count changed"
        assert audit["summary"]["open_closure_check_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness audit open closure count changed"
        assert audit["summary"]["blocked_decision_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness audit blocked decision count changed"
        assert audit["summary"]["blocked_acceptance_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness audit blocked acceptance count changed"
        assert audit["summary"]["accepted_evidence_packet_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness audit accepted packet count changed"
        assert audit["summary"]["acceptance_record_persisted_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness audit persisted record count changed"
        assert audit["summary"]["missing_evidence_packet_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness audit missing packet count changed"
        assert "getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessAuditConsistencyJson" in encoded, "Android activation approval decision owner handoff evidence acceptance closure readiness audit binding missing"
        assert "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-audit-consistency" in encoded, "Linux CLI activation approval decision owner handoff evidence acceptance closure readiness audit binding missing"
        assert "uib.events.subscriptions.activation.approval.decision.owner.handoff.evidence.acceptance.closure.readiness.audit.consistency" in encoded, "Linux IPC activation approval decision owner handoff evidence acceptance closure readiness audit binding missing"
        assert "GetEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessAuditConsistency" in encoded, "gRPC activation approval decision owner handoff evidence acceptance closure readiness audit binding missing"
    ...
    if path == "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist":
        ...
        encoded = json.dumps(checklist)
        gate_ids = {item["gate_id"] for item in checklist["mandatory_gates"]}
        assert checklist["operation"] == "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-checklist", "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment checklist wrong operation"
        assert checklist["state"] == "contract-only-handoff-evidence-acceptance-closure-reviewers-unassigned", "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment checklist wrong state"
        assert checklist["approval_decision_owner_handoff_evidence_acceptance_closure_readiness_decision_reviewer_assignment_checklist_active"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment checklist inactive"
        assert checklist["reviewer_assignment_checklist_complete"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment checklist incomplete"
        assert checklist["reviewer_assignment_ready"] is False, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment unexpectedly ready"
        assert checklist["source_decision_rollup_bound"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment lost EV-AHL binding"
        assert checklist["required_reviewer_assignment_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment count changed"
        assert checklist["assigned_reviewer_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment assigned reviewers"
        assert checklist["unassigned_reviewer_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment unassigned count changed"
        assert len(checklist["reviewer_assignment_rows"]) == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment rows changed"
        assert {"EV-AHM-001", "EV-AHM-002", "EV-AHM-003", "EV-AHM-004", "EV-AHM-005", "EV-AHM-006", "EV-AHM-007", "EV-AHM-008", "EV-AHM-009", "EV-AHM-010"} <= gate_ids, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment missing EV-AHM gates"
        for item in checklist["reviewer_assignment_rows"]:
            assert item["reviewer_assignment_state"] == "unassigned", f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment row assigned {item['gate_id']}"
            assert item["reviewer_id"] is None, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment row has reviewer {item['gate_id']}"
            assert item["assignment_required"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment row not required {item['gate_id']}"
            assert item["assigned"] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment row assigned flag set {item['gate_id']}"
            assert item["assignment_persisted"] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment row persisted {item['gate_id']}"
            assert item["queue_updated"] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment row updated queue {item['gate_id']}"
            assert item["consistent"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment row inconsistent {item['gate_id']}"
            assert item["blocks_approval_review"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment lost approval review block {item['gate_id']}"
            assert item["blocks_gate_closure"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment lost gate closure block {item['gate_id']}"
            assert item["blocks_broker_activation"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment lost broker block {item['gate_id']}"
            assert item["source_decision_gate_id"].startswith("EV-AHL-"), f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment missing EV-AHL source {item['gate_id']}"
            assert item["source_audit_gate_id"].startswith("EV-AHK-"), f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment missing EV-AHK source {item['gate_id']}"
            assert item["source_closure_gate_id"].startswith("EV-AHJ-"), f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment missing EV-AHJ source {item['gate_id']}"
            assert item["source_acceptance_gate_id"].startswith("EV-AHG-"), f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment missing EV-AHG source {item['gate_id']}"
            assert item["source_evidence_id"].startswith("EV-AHE-"), f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment missing EV-AHE source {item['gate_id']}"
        for key in [
            ...
            assert checklist["summary"][key] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment summary did not set {key}"
        for key in [
            "reviewer_assignment_ready",
            "reviewer_assignments_persisted",
            "reviewer_assignment_queue_updated",
            ...
            assert checklist["summary"][key] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment summary unexpectedly set {key}"
        assert checklist["summary"]["required_reviewer_assignment_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment summary required count changed"
        assert checklist["summary"]["assigned_reviewer_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment summary assigned reviewers"
        assert checklist["summary"]["unassigned_reviewer_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment summary unassigned count changed"
        assert checklist["summary"]["required_decision_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment required decision count changed"
        assert checklist["summary"]["blocked_decision_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment blocked decision count changed"
        assert checklist["summary"]["accepted_evidence_packet_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment accepted packet count changed"
        assert checklist["summary"]["acceptance_record_persisted_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment acceptance persisted count changed"
        assert checklist["summary"]["missing_evidence_packet_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment missing packet count changed"
        assert checklist["summary"]["persisted_dry_run_request_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment persisted dry-run request count changed"
        assert checklist["summary"]["persisted_dry_run_result_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment persisted dry-run result count changed"
        assert checklist["summary"]["persisted_approval_decision_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment persisted decision count changed"
        assert "getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentChecklistJson" in encoded, "Android activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment binding missing"
        assert "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-checklist" in encoded, "Linux CLI activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment binding missing"
        assert "uib.events.subscriptions.activation.approval.decision.owner.handoff.evidence.acceptance.closure.readiness.decision.reviewer.assignment.checklist" in encoded, "Linux IPC activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment binding missing"
        assert "GetEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentChecklist" in encoded, "gRPC activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment binding missing"
        assert "EV-AHM-001" in encoded and "EV-AHM-010" in encoded and "EV-AHL-010" in encoded and "EV-AHK-010" in encoded and "EV-AHJ-010" in encoded and "EV-AHG-010" in encoded and "EV-AHE-010" in encoded, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment missing gate references"
        assert "DRV-GAP-004" in encoded and "DRV-GAP-005" in encoded, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment missing Driver/HAL gap references"
        assert "NV-P-006" in encoded and "FW-U-003" in encoded and "DEL-004" in encoded, "event subscription activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment missing Req IDs"
    if path == "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist/audit-consistency":
        ...
        encoded = json.dumps(audit)
        gate_ids = {item["gate_id"] for item in audit["mandatory_gates"]}
        assert audit["operation"] == "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-audit-consistency", "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit wrong operation"
        assert audit["state"] == "contract-only-handoff-evidence-acceptance-closure-reviewer-assignment-audit-consistent", "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit wrong state"
        assert audit["approval_decision_owner_handoff_evidence_acceptance_closure_readiness_decision_reviewer_assignment_audit_consistency_active"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit inactive"
        assert audit["consistency_passed"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit failed"
        assert audit["source_reviewer_assignment_checklist_bound"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit lost source checklist"
        assert audit["reviewer_assignment_count_consistent"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit count inconsistent"
        assert audit["reviewer_assignment_blocker_state_consistent"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit blocker state inconsistent"
        assert audit["reviewer_assignment_ready"] is False, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit unexpectedly ready"
        assert audit["assigned_reviewer_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit assigned reviewers"
        assert audit["unassigned_reviewer_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit unassigned count changed"
        assert len(audit["audit_items"]) == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit items changed"
        assert {"EV-AHN-001", "EV-AHN-002", "EV-AHN-003", "EV-AHN-004", "EV-AHN-005", "EV-AHN-006", "EV-AHN-007", "EV-AHN-008", "EV-AHN-009", "EV-AHN-010"} <= gate_ids, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit missing EV-AHN gates"
        for item in audit["audit_items"]:
            assert item["passed"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit failed {item['gate_id']}"
            assert item["reviewer_assignment_still_blocked"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit lost block {item['gate_id']}"
            assert item["reviewer_assigned"] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit assigned {item['gate_id']}"
            assert item["assignment_persisted"] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit persisted {item['gate_id']}"
            assert item["queue_updated"] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit updated queue {item['gate_id']}"
            assert item["source_assignment_gate_id"].startswith("EV-AHM-"), f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit missing EV-AHM source {item['gate_id']}"
        for key in [
            ...
            assert audit["summary"][key] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit summary did not set {key}"
        for key in [
            "reviewer_assignment_ready",
            "reviewer_assignments_persisted",
            "reviewer_assignment_queue_updated",
            ...
            assert audit["summary"][key] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit summary unexpectedly set {key}"
        assert audit["summary"]["assigned_reviewer_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit summary assigned reviewers"
        assert audit["summary"]["unassigned_reviewer_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit summary unassigned count changed"
        assert "getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditConsistencyJson" in encoded, "Android activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit binding missing"
        assert "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-audit-consistency" in encoded, "Linux CLI activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit binding missing"
        assert "uib.events.subscriptions.activation.approval.decision.owner.handoff.evidence.acceptance.closure.readiness.decision.reviewer.assignment.audit.consistency" in encoded, "Linux IPC activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit binding missing"
        assert "GetEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditConsistency" in encoded, "gRPC activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit binding missing"
        assert "EV-AHN-001" in encoded and "EV-AHN-010" in encoded and "EV-AHM-010" in encoded and "EV-AHL-010" in encoded, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit missing gate references"
        assert "DRV-GAP-004" in encoded and "DRV-GAP-005" in encoded, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit missing Driver/HAL gap references"
        assert "NV-P-006" in encoded and "FW-U-003" in encoded and "DEL-004" in encoded, "event subscription activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit missing Req IDs"
    if path == "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist/audit-consistency/decision-rollup":
        ...
        encoded = json.dumps(decision)
        gate_ids = {item["gate_id"] for item in decision["mandatory_gates"]}
        assert decision["operation"] == "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-audit-decision-rollup", "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup wrong operation"
        assert decision["state"] == "contract-only-handoff-evidence-acceptance-closure-reviewer-assignment-decision-blocked", "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup wrong state"
        assert decision["approval_decision_owner_handoff_evidence_acceptance_closure_readiness_decision_reviewer_assignment_audit_decision_rollup_active"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup inactive"
        assert decision["decision_rollup_complete"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup incomplete"
        assert decision["decision_rollup_consistent"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup inconsistent"
        assert decision["source_reviewer_assignment_audit_bound"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup lost audit source"
        assert decision["reviewer_assignment_audit_consistent"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup audit inconsistent"
        assert decision["reviewer_assignment_decision_blocked"] is True, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup no longer blocked"
        assert decision["reviewer_assignment_decision_ready"] is False, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup unexpectedly ready"
        assert decision["reviewer_assignment_decision"] == "blocked-by-unassigned-reviewers", "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup wrong decision"
        assert decision["required_decision_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup required count changed"
        assert decision["blocked_decision_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup blocked count changed"
        assert decision["assigned_reviewer_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup assigned reviewers"
        assert decision["unassigned_reviewer_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup unassigned count changed"
        assert len(decision["decision_items"]) == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup decision items changed"
        assert {"EV-AHO-001", "EV-AHO-002", "EV-AHO-003", "EV-AHO-004", "EV-AHO-005", "EV-AHO-006", "EV-AHO-007", "EV-AHO-008", "EV-AHO-009", "EV-AHO-010"} <= gate_ids, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup missing EV-AHO gates"
        for item in decision["decision_items"]:
            assert item["decision"] == "blocked-by-unassigned-reviewers", f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup wrong decision {item['gate_id']}"
            assert item["decision_ready"] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup ready {item['gate_id']}"
            assert item["decision_blocked"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup unblocked {item['gate_id']}"
            assert item["reviewer_assignment_audit_passed"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup audit failed {item['gate_id']}"
            assert item["reviewer_assignment_still_blocked"] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup lost block {item['gate_id']}"
            assert item["reviewer_assigned"] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup assigned {item['gate_id']}"
            assert item["assignment_persisted"] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup persisted {item['gate_id']}"
            assert item["queue_updated"] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup updated queue {item['gate_id']}"
            assert item["source_audit_gate_id"].startswith("EV-AHN-"), f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup missing EV-AHN source {item['gate_id']}"
            assert item["source_assignment_gate_id"].startswith("EV-AHM-"), f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup missing EV-AHM source {item['gate_id']}"
        for key in [
            ...
            assert decision["summary"][key] is True, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup summary did not set {key}"
        for key in [
            ...
            assert decision["summary"][key] is False, f"activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup summary unexpectedly set {key}"
        assert decision["summary"]["required_decision_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup summary required count changed"
        assert decision["summary"]["blocked_decision_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup summary blocked count changed"
        assert decision["summary"]["assigned_reviewer_count"] == 0, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup summary assigned reviewers"
        assert decision["summary"]["unassigned_reviewer_count"] == 10, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup summary unassigned count changed"
        assert "getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditDecisionRollupJson" in encoded, "Android activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup binding missing"
        assert "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-audit-decision-rollup" in encoded, "Linux CLI activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup binding missing"
        assert "uib.events.subscriptions.activation.approval.decision.owner.handoff.evidence.acceptance.closure.readiness.decision.reviewer.assignment.audit.decision.rollup" in encoded, "Linux IPC activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup binding missing"
        assert "GetEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditDecisionRollup" in encoded, "gRPC activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup binding missing"
        assert "EV-AHO-001" in encoded and "EV-AHO-010" in encoded and "EV-AHN-010" in encoded and "EV-AHM-010" in encoded and "EV-AHL-010" in encoded, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup missing gate references"
        assert "DRV-GAP-004" in encoded and "DRV-GAP-005" in encoded, "activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup missing Driver/HAL gap references"
        assert "NV-P-006" in encoded and "FW-U-003" in encoded and "DEL-004" in encoded, "event subscription activation approval decision owner handoff evidence acceptance closure readiness decision reviewer assignment audit decision rollup missing Req IDs"
    if path == "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist/audit-consistency/decision-rollup/closure-handoff-readiness-summary":
        ...
        encoded = json.dumps(readiness)
        gate_ids = {item["gate_id"] for item in readiness["mandatory_gates"]}
        assert readiness["operation"] == "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-audit-decision-rollup-closure-handoff-readiness-summary", "activation approval decision owner handoff evidence acceptance closure handoff readiness summary wrong operation"
        assert readiness["state"] == "contract-only-handoff-evidence-acceptance-closure-handoff-readiness-blocked", "activation approval decision owner handoff evidence acceptance closure handoff readiness summary wrong state"
        assert readiness["approval_decision_owner_handoff_evidence_acceptance_closure_readiness_decision_reviewer_assignment_audit_decision_rollup_closure_handoff_readiness_summary_active"] is True, "activation approval decision owner handoff evidence acceptance closure handoff readiness summary inactive"
        assert readiness["source_decision_rollup_bound"] is True and readiness["decision_rollup_consistent"] is True, "activation approval decision owner handoff evidence acceptance closure handoff readiness summary lost source decision rollup"
        assert readiness["closure_handoff_readiness_complete"] is True, "activation approval decision owner handoff evidence acceptance closure handoff readiness summary incomplete"
        assert readiness["closure_handoff_ready"] is False and readiness["handoff_ready"] is False, "activation approval decision owner handoff evidence acceptance closure handoff readiness summary unexpectedly ready"
        assert readiness["activation_decision"] == "blocked-by-unassigned-reviewers", "activation approval decision owner handoff evidence acceptance closure handoff readiness summary wrong activation decision"
        assert readiness["reviewer_assignment_decision_blocked"] is True, "activation approval decision owner handoff evidence acceptance closure handoff readiness summary lost reviewer block"
        assert readiness["required_handoff_dependency_count"] == 10 and readiness["open_handoff_dependency_count"] == 10, "activation approval decision owner handoff evidence acceptance closure handoff readiness summary dependency count changed"
        assert readiness["assigned_reviewer_count"] == 0 and readiness["unassigned_reviewer_count"] == 10, "activation approval decision owner handoff evidence acceptance closure handoff readiness summary reviewer count changed"
        assert len(readiness["handoff_dependencies"]) == 10, "activation approval decision owner handoff evidence acceptance closure handoff readiness summary dependencies changed"
        assert {"EV-AHP-001", "EV-AHP-002", "EV-AHP-003", "EV-AHP-004", "EV-AHP-005", "EV-AHP-006", "EV-AHP-007", "EV-AHP-008", "EV-AHP-009", "EV-AHP-010"} <= gate_ids, "activation approval decision owner handoff evidence acceptance closure handoff readiness summary missing EV-AHP gates"
        for item in readiness["handoff_dependencies"]:
            assert item["dependency_state"] == "blocked", f"activation approval decision owner handoff evidence acceptance closure handoff readiness summary unblocked {item['gate_id']}"
            assert item["handoff_ready"] is False, f"activation approval decision owner handoff evidence acceptance closure handoff readiness summary ready {item['gate_id']}"
            assert item["blocks_approval_review"] is True, f"activation approval decision owner handoff evidence acceptance closure handoff readiness summary lost approval block {item['gate_id']}"
            assert item["blocks_gate_closure"] is True, f"activation approval decision owner handoff evidence acceptance closure handoff readiness summary lost gate block {item['gate_id']}"
            assert item["blocks_broker_activation"] is True, f"activation approval decision owner handoff evidence acceptance closure handoff readiness summary lost broker block {item['gate_id']}"
            assert item["source_gate_id"].startswith("EV-AHO-"), f"activation approval decision owner handoff evidence acceptance closure handoff readiness summary missing EV-AHO source {item['gate_id']}"
            assert item["source_audit_gate_id"].startswith("EV-AHN-"), f"activation approval decision owner handoff evidence acceptance closure handoff readiness summary missing EV-AHN source {item['gate_id']}"
            assert item["source_assignment_gate_id"].startswith("EV-AHM-"), f"activation approval decision owner handoff evidence acceptance closure handoff readiness summary missing EV-AHM source {item['gate_id']}"
        for key in [
            ...
            assert readiness["summary"][key] is True, f"activation approval decision owner handoff evidence acceptance closure handoff readiness summary did not set {key}"
        for key in [
            ...
            assert readiness["summary"][key] is False, f"activation approval decision owner handoff evidence acceptance closure handoff readiness summary unexpectedly set {key}"
        assert readiness["summary"]["required_handoff_dependency_count"] == 10 and readiness["summary"]["open_handoff_dependency_count"] == 10, "activation approval decision owner handoff evidence acceptance closure handoff readiness summary dependency count changed"
        assert readiness["summary"]["assigned_reviewer_count"] == 0 and readiness["summary"]["unassigned_reviewer_count"] == 10, "activation approval decision owner handoff evidence acceptance closure handoff readiness summary reviewer count changed"
        assert "getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditDecisionRollupClosureHandoffReadinessSummaryJson" in encoded, "Android activation approval decision owner handoff evidence acceptance closure handoff readiness summary binding missing"
        assert "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-audit-decision-rollup-closure-handoff-readiness-summary" in encoded, "Linux CLI activation approval decision owner handoff evidence acceptance closure handoff readiness summary binding missing"
        assert "uib.events.subscriptions.activation.approval.decision.owner.handoff.evidence.acceptance.closure.readiness.decision.reviewer.assignment.audit.decision.rollup.closure.handoff.readiness.summary" in encoded, "Linux IPC activation approval decision owner handoff evidence acceptance closure handoff readiness summary binding missing"
        assert "GetEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditDecisionRollupClosureHandoffReadinessSummary" in encoded, "gRPC activation approval decision owner handoff evidence acceptance closure handoff readiness summary binding missing"
    ...
    if path == "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist/audit-consistency/decision-rollup/closure-handoff-readiness-summary/audit-consistency/decision-rollup":
        ...
        encoded = json.dumps(rollup)
        gate_ids = {item["gate_id"] for item in rollup["mandatory_gates"]}
        assert rollup["operation"] == "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-audit-decision-rollup-closure-handoff-readiness-audit-decision-rollup", "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup wrong operation"
        assert rollup["state"] == "contract-only-handoff-evidence-acceptance-closure-handoff-readiness-audit-decision-blocked", "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup wrong state"
        assert rollup["approval_decision_owner_handoff_evidence_acceptance_closure_readiness_decision_reviewer_assignment_audit_decision_rollup_closure_handoff_readiness_audit_decision_rollup_active"] is True, "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup inactive"
        assert rollup["decision_rollup_complete"] is True and rollup["decision_rollup_consistent"] is True, "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup inconsistent"
        assert rollup["closure_handoff_audit_decision_blocked"] is True and rollup["closure_handoff_audit_decision_ready"] is False, "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup unexpectedly ready"
        assert rollup["required_decision_count"] == 10 and rollup["blocked_decision_count"] == 10, "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision count changed"
        assert rollup["passed_audit_count"] == 10 and rollup["failed_audit_count"] == 0, "activation approval decision owner handoff evidence acceptance closure handoff readiness audit pass count changed"
        assert rollup["assigned_reviewer_count"] == 0 and rollup["unassigned_reviewer_count"] == 10, "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision reviewer count changed"
        assert {"EV-AHR-001", "EV-AHR-002", "EV-AHR-003", "EV-AHR-004", "EV-AHR-005", "EV-AHR-006", "EV-AHR-007", "EV-AHR-008", "EV-AHR-009", "EV-AHR-010"} <= gate_ids, "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup missing EV-AHR gates"
        assert len(rollup["decision_items"]) == 10, "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision item count changed"
        for item in rollup["decision_items"]:
            assert item["decision_state"] == "blocked", f"activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision unblocked {item['gate_id']}"
            assert item["decision_ready"] is False, f"activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision ready {item['gate_id']}"
            assert item["source_audit_gate_id"].startswith("EV-AHQ-"), f"activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision missing EV-AHQ source {item['gate_id']}"
            assert item["source_handoff_gate_id"].startswith("EV-AHP-"), f"activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision missing EV-AHP source {item['gate_id']}"
            assert item["source_decision_gate_id"].startswith("EV-AHO-"), f"activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision missing EV-AHO source {item['gate_id']}"
            assert item["reviewer_assigned"] is False and item["assignment_persisted"] is False and item["queue_updated"] is False, f"activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision side effect {item['gate_id']}"
        for key in [
            ...
            assert rollup["summary"][key] is True, f"activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup did not set {key}"
        for key in [
            ...
            assert rollup["summary"][key] is False, f"activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup unexpectedly set {key}"
        assert "getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditDecisionRollupClosureHandoffReadinessAuditDecisionRollupJson" in encoded, "Android activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup binding missing"
        assert "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-audit-decision-rollup-closure-handoff-readiness-audit-decision-rollup" in encoded, "Linux CLI activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup binding missing"
        assert "uib.events.subscriptions.activation.approval.decision.owner.handoff.evidence.acceptance.closure.readiness.decision.reviewer.assignment.audit.decision.rollup.closure.handoff.readiness.audit.decision.rollup" in encoded, "Linux IPC activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup binding missing"
        assert "GetEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditDecisionRollupClosureHandoffReadinessAuditDecisionRollup" in encoded, "gRPC activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup binding missing"
        assert "EV-AHR-001" in encoded and "EV-AHR-010" in encoded and "EV-AHQ-010" in encoded and "EV-AHP-010" in encoded, "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup missing gate references"
        assert "DRV-GAP-004" in encoded and "DRV-GAP-005" in encoded, "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup missing Driver/HAL gap references"
        assert "NV-P-006" in encoded and "FW-U-003" in encoded and "DEL-004" in encoded, "event subscription activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup missing Req IDs"
    if path == "/uib/events/subscriptions/activation-evidence/approval-authority-checklist/decision-dry-run/closure-blocker-matrix/owner-handoff-checklist/audit-consistency/decision-rollup/handoff-evidence-readiness-matrix/audit-consistency/acceptance-status/audit-consistency/decision-rollup/closure-readiness-checklist/audit-consistency/decision-rollup/reviewer-assignment-checklist/audit-consistency/decision-rollup/closure-handoff-readiness-summary/audit-consistency/decision-rollup/closure-blocker-matrix":
        ...
        encoded = json.dumps(matrix)
        gate_ids = {item["gate_id"] for item in matrix["mandatory_gates"]}
        assert matrix["operation"] == "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-audit-decision-rollup-closure-handoff-readiness-audit-decision-rollup-closure-blocker-matrix", "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup closure blocker matrix wrong operation"
        assert matrix["state"] == "contract-only-handoff-evidence-acceptance-closure-handoff-readiness-audit-decision-closure-blocked", "activation approval decision owner handoff evidence acceptance closure handoff readiness audit decision rollup closure blocker matrix wrong state"
        assert matrix["approval_decision_owner_handoff_evidence_acceptance_closure_readiness_decision_reviewer_assignment_audit_decision_rollup_closure_handoff_readiness_audit_decision_rollup_closure_blocker_matrix_active"] is True, "activation approval decision owner handoff evidence acceptance closure blocker matrix inactive"
        assert matrix["source_closure_handoff_readiness_audit_decision_rollup_bound"] is True, "activation approval decision owner handoff evidence acceptance closure blocker matrix source rollup unbound"
        assert matrix["closure_blocker_matrix_complete"] is True and matrix["closure_blocker_matrix_consistent"] is True, "activation approval decision owner handoff evidence acceptance closure blocker matrix inconsistent"
        assert matrix["closure_handoff_audit_decision_blocked"] is True and matrix["closure_handoff_closure_ready"] is False, "activation approval decision owner handoff evidence acceptance closure blocker matrix unexpectedly ready"
        assert matrix["required_blocker_count"] == 10 and matrix["open_blocker_count"] == 10 and matrix["closed_blocker_count"] == 0, "activation approval decision owner handoff evidence acceptance closure blocker counts changed"
        assert matrix["assigned_reviewer_count"] == 0 and matrix["unassigned_reviewer_count"] == 10, "activation approval decision owner handoff evidence acceptance closure blocker reviewer count changed"
        assert {"EV-AHS-001", "EV-AHS-002", "EV-AHS-003", "EV-AHS-004", "EV-AHS-005", "EV-AHS-006", "EV-AHS-007", "EV-AHS-008", "EV-AHS-009", "EV-AHS-010"} <= gate_ids, "activation approval decision owner handoff evidence acceptance closure blocker matrix missing EV-AHS gates"
        assert len(matrix["blocker_items"]) == 10, "activation approval decision owner handoff evidence acceptance closure blocker item count changed"
        for item in matrix["blocker_items"]:
            assert item["blocker_state"] == "open", f"activation approval decision owner handoff evidence acceptance closure blocker closed {item['gate_id']}"
            assert item["closure_blocked"] is True and item["blocker_ready_to_close"] is False, f"activation approval decision owner handoff evidence acceptance closure blocker ready {item['gate_id']}"
            assert item["source_decision_gate_id"].startswith("EV-AHR-"), f"activation approval decision owner handoff evidence acceptance closure blocker missing EV-AHR source {item['gate_id']}"
            assert item["source_audit_gate_id"].startswith("EV-AHQ-"), f"activation approval decision owner handoff evidence acceptance closure blocker missing EV-AHQ source {item['gate_id']}"
            assert item["source_handoff_gate_id"].startswith("EV-AHP-"), f"activation approval decision owner handoff evidence acceptance closure blocker missing EV-AHP source {item['gate_id']}"
            assert item["source_assignment_gate_id"].startswith("EV-AHM-"), f"activation approval decision owner handoff evidence acceptance closure blocker missing EV-AHM source {item['gate_id']}"
            assert item["owner_assigned"] is False and item["reviewer_assigned"] is False, f"activation approval decision owner handoff evidence acceptance closure blocker assigned {item['gate_id']}"
            assert item["assignment_persisted"] is False and item["queue_updated"] is False and item["gate_closed"] is False, f"activation approval decision owner handoff evidence acceptance closure blocker side effect {item['gate_id']}"
        for key in [
            ...
            assert matrix["summary"][key] is True, f"activation approval decision owner handoff evidence acceptance closure blocker matrix did not set {key}"
        for key in [
            ...
            assert matrix["summary"][key] is False, f"activation approval decision owner handoff evidence acceptance closure blocker matrix unexpectedly set {key}"
        assert "getEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditDecisionRollupClosureHandoffReadinessAuditDecisionRollupClosureBlockerMatrixJson" in encoded, "Android activation approval decision owner handoff evidence acceptance closure blocker matrix binding missing"
        assert "event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-audit-decision-rollup-closure-handoff-readiness-audit-decision-rollup-closure-blocker-matrix" in encoded, "Linux CLI activation approval decision owner handoff evidence acceptance closure blocker matrix binding missing"
        assert "uib.events.subscriptions.activation.approval.decision.owner.handoff.evidence.acceptance.closure.readiness.decision.reviewer.assignment.audit.decision.rollup.closure.handoff.readiness.audit.decision.rollup.closure.blocker.matrix" in encoded, "Linux IPC activation approval decision owner handoff evidence acceptance closure blocker matrix binding missing"
        assert "GetEventSubscriptionActivationApprovalDecisionOwnerHandoffEvidenceAcceptanceClosureReadinessDecisionReviewerAssignmentAuditDecisionRollupClosureHandoffReadinessAuditDecisionRollupClosureBlockerMatrix" in encoded, "gRPC activation approval decision owner handoff evidence acceptance closure blocker matrix binding missing"
        assert "EV-AHS-001" in encoded and "EV-AHS-010" in encoded and "EV-AHR-010" in encoded and "EV-AHQ-010" in encoded, "activation approval decision owner handoff evidence acceptance closure blocker matrix missing gate references"
        assert "DRV-GAP-004" in encoded and "DRV-GAP-005" in encoded, "activation approval decision owner handoff evidence acceptance closure blocker matrix missing Driver/HAL gap references"
        assert "NV-P-006" in encoded and "FW-U-003" in encoded and "DEL-004" in encoded, "event subscription activation approval decision owner handoff evidence acceptance closure blocker matrix missing Req IDs"
...
CENTRAL_BRAIN_BASE_URL="$BASE_URL" python3 "$ROOT_DIR/central-brain/linux-cli/central_brain_cli.py" event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-checklist >/dev/null
...
CENTRAL_BRAIN_BASE_URL="$BASE_URL" python3 "$ROOT_DIR/central-brain/linux-cli/central_brain_cli.py" event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-audit-decision-rollup-closure-handoff-readiness-audit-decision-rollup >/dev/null
CENTRAL_BRAIN_BASE_URL="$BASE_URL" python3 "$ROOT_DIR/central-brain/linux-cli/central_brain_cli.py" event-subscription-activation-approval-decision-owner-handoff-evidence-acceptance-closure-readiness-decision-reviewer-assignment-audit-decision-rollup-closure-handoff-readiness-audit-decision-rollup-closure-blocker-matrix >/dev/null
