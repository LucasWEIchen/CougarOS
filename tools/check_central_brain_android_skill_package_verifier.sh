...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P5-W05` Skill package verifier'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W05 Skill package verifier trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P5-W05 Skill package verifier"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P5-W05 Skill package verifier architecture"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "P5-W05 Skill package verifier detailed design"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P5-W05 Skill package verifier"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W05 Skill package verifier Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "DEV-067 P5-W05 static package verification is not production artifact trust"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "ISSUE-040 Trusted signer evidence and atomic Skill policy publication ownership"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W05 Skill package verifier"
