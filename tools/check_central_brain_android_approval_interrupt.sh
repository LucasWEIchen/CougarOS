...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P3-W05` Durable approval interrupt'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P3-W05 Durable approval interrupt trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "P3-W05 implemented approval interrupt contract"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P3-W05 Durable Approval Interrupt"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P3-W05 Durable Approval Interrupt"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P3-W05 Approval Interrupt Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P3-W05 approval interrupt"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P3-W05 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P3-W05 Durable approval interrupt"
