...
require_text "docs/CENTRAL_BRAIN_ANDROID_RUNTIME_EVOLUTION_PLAN.md" "R6B1 bounded Memory lifecycle"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "R6B1 bounded Memory lifecycle trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android R6B1 Bounded Memory Lifecycle"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android R6B1 Bounded Memory Lifecycle"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "R6B1 Memory Lifecycle Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "R6B1 进展"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "R6B1 进展"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "R6B1 bounded Memory lifecycle"
