...
require_text "docs/CENTRAL_BRAIN_ANDROID_RUNTIME_EVOLUTION_PLAN.md" "R6C2 fixed governance middleware chain"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "R6C2 fixed governance middleware trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android R6C2 Fixed Governance Middleware Chain"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android R6C2 Fixed Governance Middleware Chain"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "R6C2 Governance Middleware Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "R6C2 进展"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "R6C2 进展"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "R6C2 fixed governance middleware chain"
