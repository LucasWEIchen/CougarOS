...
require_text "docs/CENTRAL_BRAIN_AIOS_STAGE2_DEVELOPMENT_BACKLOG.md" '`P3-W02` Typed node executors'
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "P3-W02 Typed Node Executor trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android P3-W02 Typed Node Executors"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android P3-W02 Typed Node Executors"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "P3-W02 Typed Node Executor Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "P3-W02 typed executor"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "P3-W02 进展"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "P3-W02 Typed node executors"
