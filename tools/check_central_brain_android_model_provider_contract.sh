...
require_text "docs/CENTRAL_BRAIN_ANDROID_RUNTIME_EVOLUTION_PLAN.md" "R5A1 model provider contract"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "R5A1 model provider contract trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android R5A1 Model Provider Contract"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android R5A1 Model Provider Contract"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "R5A1 Model Provider Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "R5A1 进展"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "R5A1 进展"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "R5A1 model provider contract"
