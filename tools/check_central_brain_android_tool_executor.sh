...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P5-W04` ToolExecutor boundary'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W04 Tool Executor boundary trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P5-W04 Tool Executor"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P5-W04 Tool Executor architecture"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "P5-W04 Tool Executor detailed design"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P5-W04 Tool Executor"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W04 Tool Executor Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "DEV-066 P5-W04 built-in execution is not production Tool authority"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "ISSUE-039 Production built-in signer and cooperative cancellation ownership"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W04 ToolExecutor boundary"
