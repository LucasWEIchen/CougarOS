...
require_text "docs/CENTRAL_BRAIN_AIOS_STAGE2_DEVELOPMENT_BACKLOG.md" '`P2-W02` Vehicle capability catalog'
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "P2-W02 vehicle capability catalog trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android P2-W02 Vehicle Capability Catalog"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android P2-W02 Vehicle Capability Catalog"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "P2-W02 Capability Catalog Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "P2-W02 进展"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "P2-W02 进展"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "P2-W02 vehicle capability catalog"
