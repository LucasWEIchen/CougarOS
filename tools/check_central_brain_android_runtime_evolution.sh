...
for issue in ISSUE-021 ISSUE-022 ISSUE-023 ISSUE-024 ISSUE-025; do
  require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "$issue"
  require_text "$PLAN" "$issue"
done

for deviation in DEV-018 DEV-019; do
  require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "$deviation"
...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android Runtime Evolution Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "2026-07-12 当前实施阶段"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "| R7 |"
...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R1A Android Gradle foundation trace"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "central-brain-sdk-debug.aar"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R1A Gradle Foundation Driver/HAL Evidence"
require_text "$PLAN" "R1B device lifecycle check"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R1B Android device lifecycle trace"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "r1_api33_exit_criteria_met=false"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R1B Device Lifecycle Driver/HAL Evidence"
require_text "$PLAN" "R1C API 33 exit"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R1C Android 13 exit trace"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "r1_api33_exit_criteria_met=true"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R1C API 33 Exit Driver/HAL Evidence"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "| R1 | Android Gradle 多模块交付骨架 | AI SDK AAR、Runtime Service APK、Demo HMI APK | 已完成"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R1 Gradle 多模块、API 33"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R1 SDK AAR、Runtime Service APK、Demo HMI APK"
require_file "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md"
require_text "$PLAN" "R2A compiled AIDL contract"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R2A compiled AIDL contract trace"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "S2-SES-001"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R2A AIDL Contract Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R2 Typed AIDL Contract"
require_text "$PLAN" "R2B typed Binder runtime"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R2B typed Binder runtime trace"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "typed_binder_connected=true"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R2B Binder Runtime Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R2C 已通过 API 33"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R2C"
require_text "$PLAN" "R2C Binder lifecycle/race instrumentation"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R2C Binder lifecycle and race trace"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "r2_binder_exit_criteria_met=true"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R2C Binder Lifecycle Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "| R2 | Typed/async Protocol Binding | production/diagnostic AIDL、Parcelable、callback/cancel/death | 已完成"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "R2C Lifecycle And Race Evidence"
...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R3A Job Supervisor foundation trace"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "trusted_caller_identity_resolved=true"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R3A Job Supervisor Driver/HAL Boundary"
require_text "$PLAN" "R3B capability policy"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R3B capability policy trace"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "unknown_client_default_deny_verified=true"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R3B Capability Policy Driver/HAL Boundary"
...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "| R3 | Android Runtime 核心 | Job Supervisor、可信 Binder 身份、capability/policy | 已完成"
...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4B1 durable task admission trace"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android R4B1 Durable Task Admission"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4B1 Durable Repository Driver/HAL Boundary"
...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4B3 durable approval trace"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android R4B3 Durable Approval"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4B3 Durable Approval Driver/HAL Boundary"
...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4C3A effect adapter contract trace"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android R4C3A Effect Adapter Contract"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4C3A Effect Adapter Driver/HAL Boundary"
...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4C3C production fail-closed activation visibility trace"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android R4C3C Production Fail-Closed Activation Visibility"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4C3C Production Gate Visibility Driver/HAL Boundary"
...
bash "$ROOT_DIR/tools/check_central_brain_android_model_contract_v2.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_model_provider_registry.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_policy_aware_model_router.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_local_model_provider.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_structured_model_output.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_scenario_evaluation.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_model_resource_admission.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_p7_physical_acceptance.sh"
...
bash "$ROOT_DIR/tools/check_central_brain_android_release_evidence_envelope.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_field_diagnostics_probe.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_release_retest_workflow.sh"
...
# P4-R3 intentionally removes the legacy manual HVAC/seat drawers and the
# four-stage navigation. Its contract covers the live trace, simulated actuator
# feedback, failure recovery, driving-state projection, and display bounds.
...
bash "$ROOT_DIR/tools/check_central_brain_android_skill_package_verifier.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_working_memory_store.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_profile_memory_store.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_episodic_memory_store.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_context_budget_manager.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_memory_consent_hmi.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_p5_physical_acceptance.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_event_broker.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_event_backpressure_qos.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_trigger_engine.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_proactive_consent_policy.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_context_source_adapters.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_active_suggestion_ux.sh"
bash "$ROOT_DIR/tools/check_central_brain_android_p6_physical_acceptance.sh"
