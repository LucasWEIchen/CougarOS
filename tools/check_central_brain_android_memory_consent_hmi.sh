...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P5-W10` Memory consent HMI/API'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W10 Memory consent HMI/API trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P5-W10 Memory consent HMI/API"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P5-W10 Memory consent HMI/API architecture"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "P5-W10 Memory consent HMI/API detailed design"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P5-W10 Memory consent HMI/API"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W10 Memory consent HMI/API Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "DEV-072 P5-W10 process-local Memory consent projection is not production Memory control"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "ISSUE-045 Memory consent authority and repository mutation publication"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W10 Memory consent HMI/API"
