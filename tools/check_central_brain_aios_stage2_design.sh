...
SECURITY_EVIDENCE_INTERFACE="$ROOT_DIR/central-brain/contracts/central_brain_android_p9_security_evidence_interface.json"
...
require_text "$DEVIATIONS" 'DEV-114 P9-W03g executable security campaign is suspended'
...
require_text "$README" 'field_diagnostics_projection_defined=true'
require_text "$README" 'field_diagnostics_audit_key_count=31'
require_text "$README" 'field_diagnostics_android_debug_probe_executed=false'
require_text "$README" 'field_diagnostics_target_category_execution_complete=false'
require_text "$BACKLOG" 'P9-W07b debug-only field diagnostics probe and host adapter'
require_text "$REQUIREMENTS" 'P9-W07b field diagnostics probe trace'
require_text "$DEVIATIONS" 'DEV-099 P9-W07b debug diagnostics are not complete field acceptance'
require_text "$DELIVERY" 'Android P9-W07b Field Diagnostics Probe'
require_text "$DRIVER" 'P9-W07b Field Diagnostics Probe Driver/HAL Boundary'
require_text "$README" 'release_retest_state_machine_defined=true'
require_text "$README" 'release_retest_issue_state_count=5'
require_text "$README" 'release_retest_transition_count=5'
require_text "$README" 'release_retest_automatic_issue_close_allowed=false'
require_text "$BACKLOG" 'P9-W07c replacement release and issue/retest state machine'
require_text "$REQUIREMENTS" 'P9-W07c replacement release and issue/retest trace'
...
require_text "$README" 'event_qos_android13_arm64_verified=true'
...
require_text "$README" 'trigger_engine_android13_arm64_verified=true'
...
require_text "$README" 'proactive_consent_android13_arm64_verified=true'
...
require_text "$README" 'context_source_android13_arm64_verified=true'
...
require_text "$README" 'active_suggestion_android13_arm64_verified=true'
...
require_text "$README" 'tool_manifest_android13_arm64_verified=true'
require_text "$README" 'tool_registry_contract_defined=true'
require_text "$README" 'tool_resolver_contract_defined=true'
require_text "$README" 'tool_registry_android13_arm64_verified=true'
...
require_text "$README" 'tool_rule_solver_android13_arm64_verified=true'
...
require_text "$README" 'tool_executor_android13_arm64_verified=true'
...
require_text "$README" 'skill_package_verifier_android13_arm64_verified=true'
...
bash "$ROOT_DIR/tools/check_central_brain_android_security_evidence_interface.sh"
