...
require_text "$ROADMAP" '下一实现工作包为 `P4-W02 Cockpit HMI state/reducer/reconnect`'
...
require_text "$DEVIATIONS" '## DEV-051 P4-W01 Client2 UI alias 与 legacy 生命周期仍是兼容边界'
...
require_text "$README" 'implementation_stage=P4-W02'
