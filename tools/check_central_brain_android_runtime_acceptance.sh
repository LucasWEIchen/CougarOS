...
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "R7A1 aggregate Runtime acceptance"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R7A1 aggregate Runtime acceptance trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R7A1 Runtime Acceptance Snapshot"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android R7A1 Runtime Acceptance Snapshot"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R7A1 Runtime Acceptance Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R7A1 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R7A1 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R7A1 aggregate Runtime acceptance"
