...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'P9-W03a parser security corpus'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'P9-W03a parser security corpus trace'
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" 'Android P9-W03a Parser Security Corpus Contract'
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" 'P9-W03a parser security corpus architecture'
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" 'P9-W03a parser security corpus detailed design'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'Android P9-W03a Parser Security Corpus'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'P9-W03a Parser Security Driver/HAL Boundary'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'P9-W03a deterministic corpus is not coverage-guided fuzzing'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'ISSUE-050 P9 complete security fuzz evidence is unavailable'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" 'P9-W03a Parser Security Corpus progress'
