...
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "R4B1 durable task admission"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4B1 durable task admission trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R4B1 Durable Task Admission"
...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4B1 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4B1 进展"
