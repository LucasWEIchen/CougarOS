...
require_text "docs/CENTRAL_BRAIN_ANDROID_RUNTIME_EVOLUTION_PLAN.md" "R5C1 production-safe model runtime readiness"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "R5C1 production-safe model runtime readiness trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android R5C1 Model Runtime Readiness Snapshot"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android R5C1 Production-Safe Model Runtime Readiness"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "R5C1 Model Readiness Visibility Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_NPU_RUNTIME_INTERFACE.md" "Android R5C1 model-runtime readiness"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "R5C1 进展"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "R5C1 进展"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "R5C1 production-safe readiness"
