...
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "R4C3A effect adapter contract and fault matrix"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4C3A effect adapter contract trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R4C3A Effect Adapter Contract"
...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4C3A 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4C3A 进展"
