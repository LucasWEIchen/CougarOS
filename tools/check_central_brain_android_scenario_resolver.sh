...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P2-W06` DeterministicScenarioResolver'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P2-W06 Deterministic ScenarioResolver trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P2-W06 Deterministic Scenario Resolver"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P2-W06 Deterministic Scenario Resolver"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P2-W06 Scenario Resolver Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P2-W06 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P2-W06 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P2-W06 DeterministicScenarioResolver"
