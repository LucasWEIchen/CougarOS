...
require_text "docs/CENTRAL_BRAIN_AIOS_STAGE2_DEVELOPMENT_BACKLOG.md" '`P6-W04` Proactive consent/policy'
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "P6-W04 Proactive consent/policy trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android P6-W04 Proactive consent/policy"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P6-W04 Proactive consent/policy architecture"
require_text "docs/CENTRAL_BRAIN_COMPLETE_SOFTWARE_DEVELOPMENT_DESIGN.md" "P6-W04 Proactive consent/policy detailed design"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android P6-W04 Proactive consent/policy"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "P6-W04 Proactive consent/policy Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "P6-W04 process-local proactive consent is not production authorization"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "P6-W04 proactive consent progress"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "P6-W04 Proactive consent/policy progress"
