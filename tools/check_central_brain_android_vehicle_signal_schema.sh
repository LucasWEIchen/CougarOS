...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P2-W01` Canonical vehicle signal types'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P2-W01 canonical vehicle signal trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P2-W01 Canonical Vehicle Signal Schema"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P2-W01 Canonical Vehicle Signal Schema"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P2-W01 Vehicle Signal Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P2-W01 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P2-W01 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P2-W01 canonical vehicle signal types"
