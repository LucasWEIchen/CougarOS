...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P7-W02` ModelProviderRegistry/health'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P7-W02 ModelProviderRegistry/health trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P7-W02 ModelProviderRegistry/health"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P7-W02 ModelProviderRegistry/health architecture"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "P7-W02 ModelProviderRegistry/health detailed design"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P7-W02 ModelProviderRegistry/health"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P7-W02 ModelProviderRegistry/health Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P7-W02 Registry health is metadata, not production availability"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P7-W02 ModelProviderRegistry/health progress"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P7-W02 ModelProviderRegistry/health progress"
