...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P5-W02` ToolRegistry/Resolver'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W02 Tool Registry/Resolver trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P5-W02 Tool Registry/Resolver"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P5-W02 Tool Registry/Resolver architecture"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "P5-W02 Tool Registry/Resolver detailed design"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P5-W02 Tool Registry/Resolver"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W02 Tool Registry/Resolver Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "DEV-064 P5-W02 Registry usability is not execution authority"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "ISSUE-037 Tool health publisher and production registry ownership"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W02 ToolRegistry/Resolver"
