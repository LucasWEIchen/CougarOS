...
require_text "docs/CENTRAL_BRAIN_AIOS_STAGE2_DEVELOPMENT_BACKLOG.md" '`P3-W03` CheckpointSerializer'
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "P3-W03 CheckpointSerializer trace"
require_text "docs/CENTRAL_BRAIN_COMPLETE_SOFTWARE_DEVELOPMENT_DESIGN.md" "P3-W03 implemented checkpoint contract"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android P3-W03 CheckpointSerializer"
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" "Android P3-W03 CheckpointSerializer"
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" "P3-W03 CheckpointSerializer Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "P3-W03 checkpoint serializer"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "P3-W03 进展"
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" "P3-W03 CheckpointSerializer"
