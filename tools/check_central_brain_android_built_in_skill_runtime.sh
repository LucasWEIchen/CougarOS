...
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "R6C1 signed built-in Skill runtime"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6C1 signed built-in Skill runtime trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R6C1 Signed Built-In Skill Runtime"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android R6C1 Signed Built-In Skill Runtime"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6C1 Built-In Skill Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6C1 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6C1 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R6C1 signed built-in Skill runtime"
