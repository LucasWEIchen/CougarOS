...
require_text "docs/CENTRAL_BRAIN_ANDROID_RUNTIME_EVOLUTION_PLAN.md" "R4C2A effect prepare and claim"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" "R4C2A effect prepare and claim trace"
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" "Android R4C2A Effect Prepare And Claim"
...
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" "R4C2A 进展"
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" "R4C2A 进展"
