...
require_text "docs/CENTRAL_BRAIN_AIOS_STAGE2_DEVELOPMENT_BACKLOG.md" 'P9-W04a privacy data inventory'
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_REQUIREMENTS.md" 'P9-W04a privacy data inventory trace'
require_text "docs/CENTRAL_BRAIN_INTERFACE_DESIGN.md" 'Android P9-W04a Privacy Data Inventory Contract'
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" 'P9-W04a privacy data inventory architecture'
require_text "docs/CENTRAL_BRAIN_COMPLETE_SOFTWARE_DEVELOPMENT_DESIGN.md" 'P9-W04a privacy data inventory detailed design'
require_text "docs/CENTRAL_BRAIN_DELIVERY_TARGETS.md" 'Android P9-W04a Privacy Data Inventory'
require_text "docs/CENTRAL_BRAIN_DRIVER_INTERFACE_SUPPORT.md" 'P9-W04a Privacy Data Inventory Driver/HAL Boundary'
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_DEVIATIONS.md" 'DEV-091 P9-W04a inventory is not lifecycle enforcement'
require_text "docs/CENTRAL_BRAIN_ARCHITECTURE_ISSUES.md" 'ISSUE-051 P9 durable privacy lifecycle policies are incomplete'
require_text "docs/CENTRAL_BRAIN_ROADMAP.md" 'P9-W04a Privacy Data Inventory progress'
