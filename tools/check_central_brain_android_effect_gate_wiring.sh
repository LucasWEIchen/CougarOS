...
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "R4C3C production fail-closed activation visibility"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4C3C production fail-closed activation visibility trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R4C3C Production Activation Snapshot"
...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4C3C 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4C3C 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R4_DURABLE_WORKFLOW"
