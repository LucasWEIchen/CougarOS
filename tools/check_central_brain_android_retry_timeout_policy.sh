...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P3-W04` Retry/Timeout policy'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P3-W04 Retry/Timeout policy trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "P3-W04 implemented retry/timeout contract"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P3-W04 Retry/Timeout Policy"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P3-W04 Retry/Timeout Policy"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P3-W04 Retry/Timeout Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P3-W04 retry/timeout policy"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P3-W04 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P3-W04 Retry/Timeout policy"
