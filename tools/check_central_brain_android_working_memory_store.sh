...
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" '`P5-W06` WorkingMemoryStore'
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W06 WorkingMemoryStore trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android P5-W06 WorkingMemoryStore"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_ARCHITECTURE.md" "P5-W06 WorkingMemoryStore architecture"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "P5-W06 WorkingMemoryStore detailed design"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android P5-W06 WorkingMemoryStore"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W06 WorkingMemoryStore Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "DEV-068 P5-W06 process-local Working Memory is not production Memory"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "ISSUE-041 Working Memory session owner, tokenizer and storage publication"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "P5-W06 WorkingMemoryStore"
