...
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "R5A2 inference resource scheduler"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5A2 inference resource scheduler trace"
require_text "docs/CENTRAL_BRAIN_SOFTWARE_DEVELOPMENT.md" "Android R5A2 Inference Resource Scheduler"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "Android R5A2 Inference Resource Scheduler"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5A2 Scheduler Driver/HAL Boundary"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5A2 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5A2 进展"
require_text "docs/CENTRAL_BRAIN_REQUIREMENTS.md" "R5A2 inference resource scheduler"
